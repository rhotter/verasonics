...
%   for its use
%
% File name SetUpL11_5vWideBeamSC_64LE.m - Example of wide beam scan sequence with
%                                          spatial compounding.
%
% Description:
%   Generate sequence program for L11_5v linear array using wide beam transmit
...
Resource.DisplayWindow(1).Title = 'L11-5vWideBeamSC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamSC_64LE_QSApp.mat');
