...
%   for its use.
%
% File name: SetUpP4_2vWideBeamPolar.m - Example of phased array imaging with
...
%   probe that is wired to the scanhead connector with elements 1-64
%   connected to inputs 33-96. We therefore need a Trans.Connector array
%   to specify the connector channels used, which will be defined by the
%   computeTrans function.
%
% Last update:
%   01-26-2017 First working version
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamPolar';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2vWideBeamPolar_QSApp.mat');
