...
%   for its use
%
% File name: SetUpL22_14vXWideBeamDoppler.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for L22-14vX Linear array, using WideBeam
...
Resource.DisplayWindow(1).Title = 'L22-14vXWideBeamDoppler';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vXWideBeamDoppler_QSApp.mat');
...
% filename = 'L22-14vXWideBeamDoppler';  VSX;
