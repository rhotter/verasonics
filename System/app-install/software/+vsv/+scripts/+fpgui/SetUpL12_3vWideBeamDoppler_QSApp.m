...
%   for its use
%
% File name: SetUpL12_3vWideBeamDoppler.m - Example of WideBeam doppler
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL12_3vWideBeamDoppler_QSApp.mat');
...
% filename = 'L12-3vWideBeamDoppler';  VSX;
