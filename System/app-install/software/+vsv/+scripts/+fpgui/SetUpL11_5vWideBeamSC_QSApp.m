...
%   for its use
%
% File name SetUpL11_5vWideBeamSC.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamSC_QSApp.mat');
