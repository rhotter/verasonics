...
%   for its use
%
% File name: SetUpC5_2vWideBeamDoppler.m - Example of WideBeam doppler
...
PData(1).Region(1).Shape.angle = (pi/180)*70;
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamDoppler';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamDoppler_QSApp.mat');
...
% filename = 'C5-2vWideBeamDoppler';  VSX;
