...
%   for its use
%
% File name: SetUpP4_2vWideBeamHIDM_32LE.m - Example of phased array imaging with
%                                        wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for P4-2v phased array in virtual apex format,
%   using m wide beam transmit pairs with pulse inversion. 64
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamHI_32LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2vWideBeamHI_32LE_QSApp.mat');
