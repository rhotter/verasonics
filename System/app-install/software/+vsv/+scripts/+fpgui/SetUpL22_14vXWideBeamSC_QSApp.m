...
%   for its use
%
% File name SetUpL22_14vXWideBeamSC.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vXWideBeamSC_QSApp.mat');
...
% filename = 'L22-14vXWideBeamSC';  VSX;
