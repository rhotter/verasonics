...
%   for its use
%
% File name: SetUpP4_2v_128RyLnsPolar_64.m - Example of phased array imaging with
...
Resource.DisplayWindow(1).Title = 'P4-2v_128RyLnsPolar_64';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2v_128RyLnsPolar_64_QSApp.mat');
