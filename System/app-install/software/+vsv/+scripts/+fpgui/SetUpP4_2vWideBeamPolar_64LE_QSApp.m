...
%   for its use
%
% File name: SetUpP4_2vWideBeamPolar_64LE.m - Example of phased array imaging with
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamPolar_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2vWideBeamPolar_64LE_QSApp.mat');
