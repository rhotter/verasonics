...
%   for its use
%
% File name: SetUpP4_2gH_128RyLnsPolar_64LE.m - Example of phased array imaging with
%                                        128 focused transmits and polar coordinates.
% Description:
%   Sequence programming file for P4-2gH phased array in virtual apex format,
%   using 128 transmit - receive acquisitions. 
...
Resource.RcvBuffer(1).colsPerFrame = 128; %only 96 used.
...
Resource.DisplayWindow(1).Title = 'P4-2gH_128RyLnsPolar_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2gH_128RyLnsPolar_64LE_QSApp.mat');

save(filename);


% **** Callback routines used by UI Cotrols. ****
