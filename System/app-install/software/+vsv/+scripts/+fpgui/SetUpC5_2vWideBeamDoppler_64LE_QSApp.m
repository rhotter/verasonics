...
%   for its use
%
% File name: SetUpC5_2vWideBeamDoppler_64LE.m - Example of WideBeam doppler
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamDoppler_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamDoppler_64LE_QSApp.mat');
