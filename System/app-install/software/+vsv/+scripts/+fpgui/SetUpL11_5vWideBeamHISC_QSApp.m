...
%   for its use
%
% File name SetUpL11_5vWideBeamHISC.m - Example of wide beam scan sequence with harmonic imaging
...
Resource.DisplayWindow(1).Title = 'L11-5vWideBeamHISC';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamHISC_QSApp.mat');
...
% filename = 'L11-5vWideBeamHISC';  VSX;
