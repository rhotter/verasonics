...
%   for its use
%
% File name: SetUpC5_2gHWideBeamPolar_64LE.m - Example of curved array imaging with
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamPolar_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2gHWideBeamPolar_64LE_QSApp.mat');
