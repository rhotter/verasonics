...
%   for its use.
%
% File name: SetUpC5_2gHWideBeamHISC_64LE.m - Example of curved array imaging with
%            wide beam transmits and 3 angle spatial compounding
%
% Description:
%   Sequence program for C5-2gH using wide beam transmit scanning with
...
%
% Last update:
% 01/20/2019 - working with software 4.0
% 10/01/20201 - modified for C5-2gH
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamHISC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2gHWideBeamHISC_64LE_QSApp.mat');
