...
%   for its use
%
% File name: SetUpL22_8vWideBeamSC.m - Example of wide beam imaging
...
P.txFocusMm = 40;   % transmit focal pt in wavelengths
...
Resource.DisplayWindow(1).Title = 'L22-8vWideBeamSC';
...
TGC.CntrlPts = [0,250,550,891,925,965,1000,1023];
...
SeqControl(3).argument = 45000; %45000 usec = 45msec time between frames
...
UI(2).Control = VsSliderControl('LocationCode','UserA1',...
    'Label',['Range (',AxesUnit,')'],'SliderMinMaxVal',[1,P.maxDepthMm,P.endDepthMm]*scaleToWvl,...
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_8vWideBeamSC_QSApp.mat');
