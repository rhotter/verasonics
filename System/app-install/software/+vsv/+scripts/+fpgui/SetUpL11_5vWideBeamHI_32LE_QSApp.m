...
%   for its use
%
% File name: SetUpL11_5vWideBeamHI_32LE.m - Pulse inversion imaging with widebeam transmit
%
% Description:
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamHI_32LE_QSApp.mat');
