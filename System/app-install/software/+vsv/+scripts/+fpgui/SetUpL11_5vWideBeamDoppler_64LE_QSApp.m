...
%   for its use
%
% File name: SetUpL11_5vWideBeamDoppler_64LE.m - Example of WideBeam 2D amd Doppler
%   imaging.
%
% Description:
%   Sequence programming file for L11-5v Linear array, using WideBeam transmits
...
%   08/20/18 - modified for software release 3.5.
...
filename = 'MatFiles/L11-5vWideBeamDoppler_64LE';
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamDoppler_64LE_QSApp.mat');
