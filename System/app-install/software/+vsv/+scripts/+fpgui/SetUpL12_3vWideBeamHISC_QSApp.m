...
%    its use.
%
% File Name: SetUpL12_3vWideBeamHISC.m - Wide beam, Harmonic Imaging, Spatial Compounding example
%
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL12_3vWideBeamHISC_QSApp.mat');
...
% filename = 'L12-3vWideBeamHISC';  VSX;
