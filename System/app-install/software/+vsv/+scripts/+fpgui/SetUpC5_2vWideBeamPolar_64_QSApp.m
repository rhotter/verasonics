...
%   for its use
%
% File name: SetUpC5_2vWideBeamPolar_64.m - Example of curved array imaging with
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamPolar_64';
...
UI(3).Control = VsSliderControl('LocationCode','UserB4','Label',['TX Focus (',AxesUnit,')'],...
                  'SliderMinMaxVal',[100,1200,P.txFocus],...
                  'SliderStep',[10/500,20/500],'ValueFormat','%3.0f', ...
                  'Callback', @TxFocusCallback);

% - numTx
UI(4).Control = VsSliderControl('LocationCode','UserB3','Label','numTx',...
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamPolar_64_QSApp.mat');
