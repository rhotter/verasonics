...
%   for its use
%
% File name: SetUpP4_2vWideBeam_32LE.m - Example of phased array imaging with
%                                        wide beam transmits and polar coordinates.
% Description:
%   Sequence programming file for P4-2v phased array in virtual apex format,
%   using m wide beam transmits and receive acquisitions. 64
%   transmit and 32 receive channels are active for each acquisition.
...
%   elements 1-64 connected to inputs 33-96.
%
% Last update:
% 08/30/2018 - created for 32LE system.
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamPolar_32LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2vWideBeam_32LE_QSApp.mat');
