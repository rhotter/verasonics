...
%   for its use
%
% File name: SetUpL11_5gHWideBeamDoppler.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for L11-5gH Linear array, using WideBeam
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5gHWideBeamDoppler_QSApp.mat');
...
% filename = 'L11-5gHWideBeamDoppler';  VSX;
