...
%   for its use
%
% File Name: SetUpL11_5vWideBeamHISC_64LE.m - Example of wide beam scan sequence with
%   pulse inversion harmonic imaging and spatial compounding.
%
% Description:
%   Sequence program for L11_5v linear array using wide beam transmit scanning with
...
Resource.DisplayWindow(1).Title = 'L11-5vWideBeamHISC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamHISC_64LE_QSApp.mat');
