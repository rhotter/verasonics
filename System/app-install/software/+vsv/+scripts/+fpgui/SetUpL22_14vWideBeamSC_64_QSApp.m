...
%   for its use
%
% File name SetUpL22_14vWideBeamSC_64.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vWideBeamSC_64_QSApp.mat');
...
% filename = 'L22-14vWideBeamSC_64'; VSX;


% **** Callback functions to used by UI controls. ****
