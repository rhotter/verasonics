...
%   for its use.
%
% File name SetUpL22_14vWideBeamSC_32LE.m: example of linear array wide beam
...
Resource.DisplayWindow(1).Title = 'L22-14vWideBeamSC_32LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vWideBeamSC_32LE_QSApp.mat');
