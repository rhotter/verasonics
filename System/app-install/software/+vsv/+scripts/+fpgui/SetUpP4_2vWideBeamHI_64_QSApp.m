...
%   for its use
%
% File name: SetUpP4_2vWideBeamHI_64.m - Example of phased array imaging with
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamHI_64';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:P.numRays
        ...
        Receive(k+j+P.numRays).aperture = TX(j).aperture;
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2vWideBeamHI_64_QSApp.mat');
