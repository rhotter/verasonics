...
%    its use.
%
% File Name: SetUpL12_3vWideBeamSC.m - Wide beam, spatial compounding example
%
...
%    Wide beam transmits and receive acquisitions are used with a 128 element aperture that is
...
demodFreq = 7.8125; % supported frequency
...
Resource.DisplayWindow.Title = 'L12-3vWideBeamSC';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL12_3vWideBeamSC_QSApp.mat');
