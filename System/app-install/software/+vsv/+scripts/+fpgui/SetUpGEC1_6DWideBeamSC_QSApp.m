...
%   for its use.
%
% File name: SetUpGEC1_6DWideBeamSC.m - Example of curved array imaging with
...
P.numTx = 96;   % no. of elements in TX aperture.
...
Resource.DisplayWindow(1).Title = 'GEC1-6DWideBeamSC';
...
% - We need 3*P.numRays transmit specifications.
...
TGC.CntrlPts = [0,147,385,607,718,778,838,847];
...
UI(2).Control = {'UserA1','Style','VsSlider','Label',['Range (',AxesUnit,')'],'SliderMinMaxVal',MinMaxVal,...
    'SliderStep',[10/stepBase,20/stepBase],'ValueFormat','%3.0f'};
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpGEC1_6DWideBeamSC_QSApp.mat');
...
% filename = 'GEC1-6DWideBeamSC';  VSX;
