...
%   for its use
%
% File name: SetUpL11_4vWideBeamDoppler_64LE.m - Example of WideBeam 2D amd Doppler
%   imaging.
%
% Description:
...
%
% Last update:
%   06/19/19 - modified for software release 4.1.
...
Resource.System.UTA = '260-S'; % This script uses the 260-S UTA.
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_4vWideBeamDoppler_64LE_QSApp.mat');
