...
%   for its use
%
% File name: SetUpL22_14vLFWideBeamDoppler67BW_32LE.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for L22-14vLF Linear array, using WideBeam
...
Resource.DisplayWindow(1).Title = 'L22-14vLFWideBeamDoppler';
...
filename = 'MatFiles/L22-14vLFWideBeamDoppler67BW_64';
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vLFWideBeamDoppler67BW_32LE_QSApp.mat');
