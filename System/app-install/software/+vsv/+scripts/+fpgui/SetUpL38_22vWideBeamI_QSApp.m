...
%   for its use.
%
% File name: SetUpL38-22vWideBeamI.m - Example of wide beam imaging
...
%    Aperture 1 (P.numTx=24, P.numRays=128):
%      ttt-------------------------------------------------------------
%      rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr--------------------------------
%    Aperture for middle beam 64 (TX.aperture=65, P.numTx=24, numRay=64):
%      -----------------------------tttttt-----------------------------
%      ----------------rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr----------------
%    Aperture for wide beam (TX.aperture=129, P.numTx=24, numRay=128):
%      -------------------------------------------------------------ttt
%      --------------------------------rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
%
...
for n = 1:P.numRays
    PData.Region(n) = struct('Shape',struct('Name','Trapezoid','Position',[TxOrgX(n),0,0],'top',...
                             P.numTx*Trans.spacing,'bottom',txdx,'height',P.endDepth));
end
...
Resource.DisplayWindow(1).Title = 'L38-22vWideBeamI';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL38_22vWideBeamI_QSApp.mat');
...
Control.Command = 'update&Run';
Control.Parameters = {'PData','InterBuffer','ImageBuffer','DisplayWindow','SeqControl','TX','Receive','Recon','TGC'};
assignin('base','Control', Control);
