...
%   for its use
%
% File name: SetUpGE4CDWideBeamDoppler.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for GE4CD curved array, using WideBeam
...
% Set 2D parameters
P.numTx = 48;   % no. of elements in TX aperture.
...
PData(1).Region(1).Shape.angle = (pi/180)*60;
...
Resource.DisplayWindow(1).Title = 'GE4CDWideBeamDoppler';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpGE4CDWideBeamDoppler_QSApp.mat');
...
% filename = 'GE4CDWideBeamDoppler';  VSX;
