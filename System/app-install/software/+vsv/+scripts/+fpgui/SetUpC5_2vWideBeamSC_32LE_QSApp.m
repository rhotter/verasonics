...
%   for its use.
%
% File name: SetUpC5_2vWideBeamSC_32LE.m - Example of curved array imaging with
...
%   The receive aperture always covers a full 32 element aperture centered
...
%
% Last update:
%   06/13/2019 - updated for use with release 4.1

%clear[ 	]+all

P.numTx = 62;   % no. of elements in TX aperture. Should no larger than 63
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamSC_32LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:P.numRays
        ...
        % Compute 32 channel Receive.Apod centered around center element
        lft = ce - 15;
        if lft < 1, lft = 1; end
        rt = ce + 16;
        if rt > Trans.numelements, rt = Trans.numelements; end
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamSC_32LE_QSApp.mat');
