...
%   for its use.
%
% File name: SetUpC5_2vWideBeamSC_64LE.m - Example of curved array imaging with
%            wide beam transmits and 3 angle spatial compounding
%
% Description:
%   Sequence programming file for the C5-2v curved array using P.numRays wide beam
%   transmits and receive acquisitions for three different steering angles. For the
...
%   P.numTx/8 and ending with the element closest to 128-P.numTx/8. (By not centering
...
%
%   All 64 receive channels are used, although the element sensitivity cutoff will
...
%
% Last update:
% 01/03/2019 - working with software 4.0
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamSC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamSC_64LE_QSApp.mat');

save(filename);


% **** Callback funcitons used by UI controls. ****
...
function RangeChangeCallback(hObject, ~, UIValue)
    ...
    for n = 1:P.numRays+1 % include first mask region
