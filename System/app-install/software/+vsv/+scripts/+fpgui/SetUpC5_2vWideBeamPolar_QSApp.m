...
%   for its use
%
% File name: SetUpC5_2vWideBeamPolar.m - Example of curved array imaging with
...
% 07/05/2019 Modified to incorporate recent optimization of 64LE script
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamPolar';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamPolar_QSApp.mat');
...
% filename = 'C5-2vWideBeamPolar';  VSX;
