...
%   for its use.
%
% File name: SetUpC5_2gHWideBeamSC_64LE.m - Example of curved array imaging with
%            wide beam transmits and 3 angle spatial compounding
%
% Description:
%   Sequence programming file for the C5-2gH curved array using P.numRays wide beam
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamSC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2gHWideBeamSC_64LE_QSApp.mat');
