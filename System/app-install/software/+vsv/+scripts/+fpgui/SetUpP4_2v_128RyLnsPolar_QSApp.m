...
%   for its use
%
% File name: SetUpP4_2v_128RyLnsPolar.m - Example of phased array imaging with
...
%   element 1-64 connected to inputs 33-96. We therefore need a
...
Resource.DisplayWindow(1).Title = 'P4_2v128RyLnsPolar';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2v_128RyLnsPolar_QSApp.mat');
