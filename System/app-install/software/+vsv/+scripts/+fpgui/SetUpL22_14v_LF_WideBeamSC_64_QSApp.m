...
%   for its use
%
% File name SetUpL22_14v_LFWideBeamSC_64.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
%   Generate sequence program for L22_14v LF linear array using wide beam transmit scanning with
...
Resource.DisplayWindow(1).Title = 'L22-14v LF WideBeamSC';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14v_LF_WideBeamSC_64_QSApp.mat');
...
% filename = 'L22-14v_LF_WideBeamSC_64'; VSX;
