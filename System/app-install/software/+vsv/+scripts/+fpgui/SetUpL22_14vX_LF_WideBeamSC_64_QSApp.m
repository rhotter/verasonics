...
%   for its use
%
% File name SetUpL22_14vX_LF_WideBeamSC_64.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
%   Generate sequence program for L22-14vX LF linear array using wide beam transmit scanning with
...
%
% Last update:
%   03/22/2020 -  created for 4.5 release
...
Resource.DisplayWindow(1).Title = 'L22-14vX LF WideBeamSC';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vX_LF_WideBeamSC_64_QSApp.mat');
...
% filename = 'L22-14vX_LF_WideBeamSC_64'; VSX;
