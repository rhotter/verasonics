...
%   for its use
%
% File name: SetUpL22_14vWideBeamDoppler.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for L22-14v Linear array, using WideBeam
...
Resource.DisplayWindow(1).Title = 'L22-14vWideBeamDoppler';
...
TW(1).Parameters = [demodFreq,0.67,1,1];
...
% - 2D TGC
TGC(1).CntrlPts = [0,342,521,643,785,858,888,920];
TGC(1).rangeMax = P.endDepth;
TGC(1).Waveform = computeTGCWaveform(TGC(1));
% - Doppler TGC
TGC(2).CntrlPts = [0,374,713,815,764,764,662,662];
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vWideBeamDoppler_QSApp.mat');
...
% filename = 'L22-14vWideBeamDoppler';  VSX;
