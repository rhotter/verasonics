...
%   for its use
%
% File name: SetUpP4_2gHWideBeamPolarHI_64LE.m - Example of phased array imaging with
%                                        wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for P4-2gH phased array in virtual apex format,
%   using m wide beam transmit pairs with pulse inversion. 96
...
Resource.DisplayWindow(1).Title = 'P4-2gHWideBeamPolarHI_64LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:P.numRays
        ...
        Receive(k+j+P.numRays).Apod(lft:rt) = 1;
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2gHWideBeamHIPolar_64LE_QSApp.mat');
