...
%   for its use
%
% File name: SetUpGE9LDWideBeamDoppler.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for GE9LD Linear array, using WideBeam
...
P.dopTxOrgChnl = [48 71 94 117];
P.dopDispEle = 92; % middle 92 elements width will be used for Doppler display
P.dopNumTx = 92;  % no. of elements in TX aperture
...
PData(3).Region.Shape = struct(...
    'Name','Parallelogram',...
    'Position',[(PData(2).Region(3).Shape.Position(1)+PData(2).Region(2).Shape.Position(1))/2,0,P.dopStartDepth,0,P.dopStartDepth],...
...
Resource.DisplayWindow(1).Title = 'GE9LDWideBeamDoppler';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpGE9LDWideBeamDoppler_QSApp.mat');
...
% filename = 'GE9LDWideBeamDoppler';  VSX;
