...
%   for its use.
%
% File name: SetUpP4_2gHWideBeamHIPolar.m - Example of phased array imaging with
...
P.startDepth = 0;
P.endDepth = 150*mm2wl;  % Acquisition depth in wavelengths
P.txFocus = -360*mm2wl;  % negative focus for slightly diverging wave
...
Resource.RcvBuffer(1).rowsPerFrame = P.numRays*4096; % max acq depth of 512 wls at 4 smpls/wl
Resource.RcvBuffer(1).colsPerFrame = Resource.Parameters.numRcvChannels;
Resource.RcvBuffer(1).numFrames = numRcvFrames;     % 20 frames used for RF cineloop.
...
% - Range Change
MinMaxVal = [64,400,P.endDepth]; % default unit is wavelength
AxesUnit = 'wls';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpP4_2gHWideBeamHIPolar_QSApp.mat');
