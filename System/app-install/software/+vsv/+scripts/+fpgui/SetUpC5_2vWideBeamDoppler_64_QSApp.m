...
%   for its use
%
% File name: SetUpC5_2vWideBeamDoppler_64.m - Example of WideBeam doppler
...
% 11/20/2018 VTS-1007 reduce Doppler TX voltage to avoid overheating HVMux chips
% 10/04/2018 Modified for dynamic MUX programming with 64 Vantage system
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamDoppler_64';
...
TPC(2).name = 'Doppler';
TPC(2).maxHighVoltage = 30; % VTS-1007 Reduce Doppler XMT to avoid damage to HVMux chips
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:m
        ...
        % Doppler acquisition
            ...
            Receive(ind+k).Apod(P.dopTxOrgChnl(j)+ApodRange) = 1;
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamDoppler_64_QSApp.mat');
