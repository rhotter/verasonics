...
%   for its use
%
% File name: SetUpL22_14vX_LF_WideBeamDoppler67BW_64.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for L22-14vX LF Linear array, using WideBeam
...
Resource.DisplayWindow(1).Title = 'L22-14vX LF WideBeamDoppler';
...
filename = 'MatFiles/L22-14vX_LF_WideBeamDoppler67BW_64';
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vX_LF_WideBeamDoppler67BW_64_QSApp.mat');
