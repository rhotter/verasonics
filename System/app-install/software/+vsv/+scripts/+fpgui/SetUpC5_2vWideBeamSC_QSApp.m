...
%   for its use.
%
% File name: SetUpC5_2vWideBeamSC.m - Example of curved array imaging with
%            wide beam transmits and spatial compounding
%
% Description:
%   Sequence programming file for C5-2v curved array using wide beam transmit
%   scanning with spatial compounding. Of the 128 transmit channels, only
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamSC';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamSC_QSApp.mat');
