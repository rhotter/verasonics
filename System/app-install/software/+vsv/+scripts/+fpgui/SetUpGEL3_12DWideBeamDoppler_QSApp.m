...
P.dopNumTx = 128;  % no. of elements in TX aperture
...
Resource.DisplayWindow(1).Title = 'GEL3-12DWideBeamDoppler';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpGEL3_12DWideBeamDoppler_QSApp.mat');
...
% filename = 'GEL3-12DWideBeamDoppler';  VSX;
