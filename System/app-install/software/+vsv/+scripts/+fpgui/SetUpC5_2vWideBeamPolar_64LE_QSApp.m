...
Resource.System.UTA = '260-S'; % This script requires the 260-MUX UTA.
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamPolar_64LE';
...
% - numTx
UI(3).Control = {'UserB3','Style','VsSlider','Label','numTx',...
                  'SliderMinMaxVal',[10,62,P.numTx],...
                  'SliderStep',[4/54,8/54],'ValueFormat','%3.0f'};
UI(3).Callback = text2cell('%numTxCallback');

% Specify factor for converting sequenceRate to frameRate.
frameRateFactor = 5;

% Save all the structures to a .mat file.
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2vWideBeamPolar_64LE_QSApp.mat');
