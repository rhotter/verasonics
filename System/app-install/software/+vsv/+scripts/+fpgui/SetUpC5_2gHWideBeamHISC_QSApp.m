...
%   for its use.
%
% File name: SetUpC5_2gHWideBeamHISC.m - Example of curved array imaging with
...
%
% Last update:
%   03/08/2021 - modified Trans parameters
...
maxBufSizePerAcq = 2*128*ceil(maxBufLength*8/128);
...
PData.Origin(1,2) = 0;
PData.Origin(1,3) = ceil(radius * cos(firstAngle)) - radius - 5;
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamHISC';
...
TGC.CntrlPts = [50,350,590,710,820,880,940,995];
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2gHWideBeamHISC_QSApp.mat');
...
% filename = 'C5-2gHWideBeamHISC';  VSX;
