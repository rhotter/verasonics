...
%   for its use
%
% File name: SetUpL22_14vWideBeamDoppler67BW_32LE.m - Example of WideBeam doppler
...
P.dopNumTx = 40;  % no. of elements in TX aperture, max 63
...
filename = 'MatFiles/L22-14vWideBeamDoppler67BW_64';
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vWideBeamDoppler67BW_32LE_QSApp.mat');
