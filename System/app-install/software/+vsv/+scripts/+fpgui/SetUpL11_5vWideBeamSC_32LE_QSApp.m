...
%   for its use
%
% File name: SetUpL11_5vWideBeamSC_32LE.m - Example of wide beam scan sequence with
%                                            spatial compounding.
%
% Description:
...
filename = 'MatFiles/L11-5vWideBeamSC_32LE';
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_5vWideBeamSC_32LE_QSApp.mat');
