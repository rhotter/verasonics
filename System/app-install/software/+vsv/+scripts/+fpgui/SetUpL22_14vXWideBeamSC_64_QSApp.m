...
%   for its use
%
% File name SetUpL22_14vXWideBeamSC_64.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
%   Generate sequence program for L22_14vX linear array using wide beam transmit scanning with
...
%   The transmit aperture size can be set by the variable - numTx. The receive aperture
%   covers 64 element aperture.
%
...
%
%   Last update:
%   03/22/2021 -  updated for 64 system to use with 4.5 release
...
P.maxDepthMm = 30;  % maxDepth for RangeChange and RcvBuffer
...
Resource.DisplayWindow(1).Title = 'L22-14vXWideBeamSC';
...
Receive = repmat(struct('Apod', ones(1,Resource.System.transmitChannels), ...
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vXWideBeamSC_64_QSApp.mat');
...
% filename = 'L22-14vXWideBeamSC_64'; VSX;
