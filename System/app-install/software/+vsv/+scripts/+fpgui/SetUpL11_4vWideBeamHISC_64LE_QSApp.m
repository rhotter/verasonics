...
%   for its use
%
% File Name: SetUpL11_4vWideBeamHISC_64LE.m - Example of wide beam scan sequence with
%   pulse inversion harmonic imaging and spatial compounding.
%
% Description:
%   Sequence program for L11_4v linear array using wide beam transmit scanning with
...
demodFreq = 8.928; % use 2X transmit frquency for demodulation frequency
...
Resource.DisplayWindow(1).Title = 'L11-4vWideBeamHISC_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_4vWideBeamHISC_64LE_QSApp.mat');
