...
%   for its use
%
% File name: SetUpC5_2gHWideBeamDoppler_64LE.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for C5-2gH curved array, using WideBeam
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamDoppler_64LE';
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpC5_2gHWideBeamDoppler_64LE_QSApp.mat');
