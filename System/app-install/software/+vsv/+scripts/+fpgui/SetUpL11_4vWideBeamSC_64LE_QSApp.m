...
%   for its use
%
% File name SetUpL11_4vWideBeamSC_64LE.m - Example of wide beam scan sequence with
%                                          spatial compounding.
%
% Description:
...
P.endDepthMm = 60;  % endDepth in mm
...
demodFreq = 6.25; % use nearest available demodulation frequency to Trans.frequency
...
Resource.DisplayWindow(1).Title = 'L11-4vWideBeamSC_64LE';
...
UI(3).Control = VsSliderControl('LocationCode','UserB3',...
    'Label','TX Aper','SliderMinMaxVal',[1,128,P.numTx],...
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL11_4vWideBeamSC_64LE_QSApp.mat');
