...
%   for its use
%
% File name SetUpL22_14vWideBeamSC.m - Example of wide beam scan sequence with spatial compounding.
%
% Description:
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL22_14vWideBeamSC_QSApp.mat');
