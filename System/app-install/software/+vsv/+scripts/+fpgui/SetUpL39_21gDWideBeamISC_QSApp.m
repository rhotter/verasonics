...
Resource.RcvBuffer(1).numFrames = numRcvFrames;    % frames stored in RcvBuffer.
...
Resource.RcvBuffer(2).numFrames = numRcvFrames;    % should be multiple of 3
...
Resource.RcvBuffer(3).numFrames = numRcvFrames;    % should be multiple of 3
...
filename = fullfile( vsv.file.getVSXDir, 'MatFiles/SetUpL39_21gDWideBeamISC_QSApp.mat');
