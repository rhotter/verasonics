...
%   for its use
%
% File name: SetUpL10_5Flash.m - Example of 2-1 synthetic aperture plane
%                                 wave imaging with signle transmit
% Description:
%   Sequence programming file for L10-5 Linear array, using 2-1 synthetic
...
Trans = computeTrans(Trans);  % L10-5 transducer is 'known' transducer so we can use computeTrans.
...
Resource.DisplayWindow(1).Title = 'L10-5Flash';
