...
%   for its use
%
% File name: SetUpL10_5FlashAngles.m - Example of 2-1 synthetic aperture plane
...
Resource.DisplayWindow(1).Title = 'L10-5FlashAngles';
...
TGC.CntrlPts = [450,600,700,750,800,850,900,950];
...
save('MatFiles/L10-5FlashAngles');
return
