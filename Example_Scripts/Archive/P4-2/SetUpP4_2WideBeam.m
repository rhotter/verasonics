...
%   for its use.
%
% File name: SetUpP4_2WideBeam.m - Example of phased array imaging with
%                                   wide beam transmits
% Description:
...
%   asynchronous with respect to acquisition. Note: The P4-2 is a 64 element
...
TGC.CntrlPts = [284,745,785,792,836,945,1023,1023];
