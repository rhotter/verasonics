...
%   for its use.
%
% File name: SetUpP4_2FlashDoppler.m - Example of phased array flash
%                                       Doppler imaging
% Description:
...
%   to acquisition. Note: The P4-2 is a 64 element probe that is wired to
...
Resource.DisplayWindow(1).Title = 'P4-2FlashDoppler';
...
save('MatFiles/P4-2FlashDoppler');
return
