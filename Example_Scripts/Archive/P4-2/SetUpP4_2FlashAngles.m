...
%   for its use.
%
% File name: SetUpP4_2FlashAngles.m - Example of phased array flash imaging
...
Resource.DisplayWindow(1).Title = 'P4-2FlashAngles';
...
TGC.CntrlPts = [87,580,639,698,801,946,1023,1023];
