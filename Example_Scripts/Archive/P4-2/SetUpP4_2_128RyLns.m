...
%   for its use
%
% File name: SetUpP4_2_128RyLns.m - Example of phased array imaging with
%                                    focus transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'P4-2_128RyLns';
