...
%   for its use.
%
% File name: SetUpP4_2Flash.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
...
Resource.DisplayWindow(1).Title = 'P4-2Flash';
...
TGC.CntrlPts = [0,551,664,725,779,928,1016,1023];
