...
%   for its use.
%
% File name: SetUpP4_2WideBeamHI.m - Example of phased array pulse inversion
%                                     imaging with wide beam transmits
% Description:
%   Sequence programming file for P4-2 phased array in virtual apex format,
...
%   Processing is asynchronous with respect to acquisition. Note: The P4-2
%   is a 64 element probe that is wired to the scanhead connector with
%   elements 0-31 connected to inputs 1-32, and elements 32-63 connected to
%   inputs 97-128. We therefore need a Trans.Connector array to specify the
...
Resource.DisplayWindow(1).Title = 'P4-2WideBeamHI';
...
TGC.CntrlPts = [344,723,741,756,840,929,1023,1023];
...
SeqControl(3).argument = 30000 - (2*P.numRays-1)*250;
