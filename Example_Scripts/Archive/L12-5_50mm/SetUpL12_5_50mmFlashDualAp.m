...
%   for its use
%
% File name: SetUpL12_5_50mmFlashDualAp.m - Demonstrate the use of separate
% transmit and receive HV Mux apertures in the same acquisition event.
% Description:
%   Sequence programming file for L12-5_50mm Linear array, using 2-1
%   synthetic aperture plane wave transmits and receive acquisitions on
%   128 channel system. Two acquisition events are
%   used with receive apertures 1:128 and 129:256, but both acquisitions
%   use a single transmit aperture at 65:192.
%
%   Element Nos.                                1         1    1               2
%                               6    8          2         7    9               5
%               1               5    6          9         2    3               6
...
%
%   The receive data from the two apertures are stored under
...
%
% Last update
%    4-11-2016 adapted from L12-5_50mmFlash
...
Resource.DisplayWindow(1).Title = 'L12-5_50mmFlashDualAp';
...
for i = 1:Resource.RcvBuffer(1).numFrames  % 3 acquisitions per frame
    ...
    % -- 2nd synthetic aperture acquisition for aperture 129.
    Receive(2*i).aperture = 129;
...
save('MatFiles/L12-5_50mmFlashDualAp');
return
