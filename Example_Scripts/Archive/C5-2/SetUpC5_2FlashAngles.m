...
%   for its use
%
% File name: SetUpC5_2FlashAngles.m - Example of curved array flash imaging
%                                      with steering angle transmits
% Description:
%   Sequence programming file for C5-2 curved array, using flash transmits
...
Resource.DisplayWindow(1).Title = 'C5-2FlashAngles';
...
TGC.CntrlPts = [0,308,451,571,604,767,850,962];
