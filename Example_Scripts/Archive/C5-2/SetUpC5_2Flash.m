...
%   for its use
%
% File name: SetUpC5_2Flash.m - Example of curved array imaging with flash
%                                transmit
% Description:
%   Sequence programming file for C5-2 curved array, using a flash transmit
...
Resource.DisplayWindow(1).Title = 'C5-2Flash';
