...
%   for its use
%
% File name: SetUpC5_2FlashDopplerLF.m - Example of curved array flash doppler
...
Resource.DisplayWindow(1).Title = 'C5-2FlashDopplerLF';
...
TW(2).Parameters = [3.125,0.67,6,1];
...
% - 2D TGC
TGC.CntrlPts = [0,271,433,487,614,726,846,942];
...
save('MatFiles/C5-2FlashDopplerLF');
return
