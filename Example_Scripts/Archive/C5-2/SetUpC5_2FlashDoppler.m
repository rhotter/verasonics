...
%   for its use
%
% File name: SetUpC5_2FlashDoppler.m - Example of curved array doppler
...
Resource.DisplayWindow(1).Title = 'C5-2FlashDoppler';
...
TW(2).Parameters = [3.125,0.67,8,1];
...
save('MatFiles/C5-2FlashDoppler');
return
