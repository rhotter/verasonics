...
%   for its use
%
% File name: SetUpC5_2_128RyLns.m - Example of curved array imaging with
%                                    focus transmits
% Description:
%   Sequence programming file for C5-2 curved array using 128 ray lines
...
Resource.DisplayWindow(1).Title = 'C5-2_128RyLns';
