...
%   for its use.
%
% File name: SetUpC5_2WideBeamHI.m - Example of curved array imaging with
%                                   wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for C5-2 curved array using numRays wide beam
...
Resource.DisplayWindow(1).Title = 'C5-2WideBeamHI';
