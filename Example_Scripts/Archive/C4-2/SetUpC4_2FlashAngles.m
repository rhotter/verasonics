...
%   for its use
%
% File name: SetUpC4_2FlashAngles.m - Example of curved array flash imaging
...
Resource.DisplayWindow(1).Title = 'C4-2FlashAngles';
...
TGC.CntrlPts = [0,529,663,774,832,895,964,1023];
