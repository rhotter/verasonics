...
%   for its use
%
% File name: SetUpC4_2_128RyLns.m - Example of curved array imaging with
%                                    focus transmits
% Description:
%   Sequence programming file for C4-2 curved array using 128 ray lines
...
Resource.DisplayWindow(1).Title = 'C4-2_128RyLns';
...
TGC.CntrlPts = [0,406,450,465,563,793,933,1023];
