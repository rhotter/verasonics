...
%   for its use.
%
% File name: SetUpC4_2WideBeam.m - Example of curved array imaging with
%                                   wide beam transmits
% Description:
%   Sequence programming file for C4-2 curved array using m wide beam
%   transmits and receive acquisitions. Of the 128 transmit channels, only
%   numTx are used, with numTx transmitters on each side of the center element
...
%
%   The PData regions are generated to provide an overlap of 3 regions at every pixel.
...
%
% Testing: Tested with software release 3.0.1
%
% Last update:
...
Trans = computeTrans(Trans);  % C4-2 transducer is 'known' transducer so we can use computeTrans.
...
Resource.DisplayWindow(1).Title = 'C4-2WideBeam';
...
TGC.CntrlPts = [0,581,714,774,934,997,1023,1023];
