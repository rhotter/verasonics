...
%   for its use
%
% File name: SetUpC4_2FlashDoppler.m - Example of curved array doppler
...
if (na > 1), dtheta2D = (24*pi/180)/(na-1); startAngle = -24*pi/180/2; else dtheta2D=0; startAngle=0; end % set dtheta2D to range over +/- 12 degrees.
...
Resource.DisplayWindow(1).Title = 'C4-2FlashDoppler';
...
TW(2).Parameters = [2.976,0.67,8,1];
...
save('MatFiles/C4-2FlashDoppler');
return
