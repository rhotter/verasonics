...
%   for its use
%
% File name: SetUpC4_2Flash.m - Example of curved array imaging with flash
%                                transmit
% Description:
%   Sequence programming file for C4-2 curved array, using a flash transmit
...
Resource.DisplayWindow(1).Title = 'C4-2Flash';
...
TGC.CntrlPts = [0,451,562,639,734,859,952,1023];
