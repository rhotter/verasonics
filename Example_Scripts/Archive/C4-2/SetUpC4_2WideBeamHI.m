...
%   for its use.
%
% File name: SetUpC4_2WideBeamHI.m - Example of curved array imaging with
%                                   wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for C4-2 curved array using numRays wide beam
...
Resource.DisplayWindow(1).Title = 'C4-2WideBeamHI';
...
TGC.CntrlPts = [255,633,656,752,759,795,920,1023];
