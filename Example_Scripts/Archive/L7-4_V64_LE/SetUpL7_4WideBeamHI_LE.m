...
%   for its use
%
% File name: SetUpL7_4WideBeamHI_LE.m - Pulse inversion imaging with widebeam transmit
%
% Description:
%   Sequence programming file for L7-4 Linear array, using widebeam pulse
...
Resource.DisplayWindow(1).Title = 'L7-4WideBeamHI_LE';
...
save('MatFiles/L7-4WideBeamHI_LE');
return
