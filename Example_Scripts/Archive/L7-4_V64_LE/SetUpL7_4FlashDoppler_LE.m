...
%   for its use
%
% File name: SetUpL7_4FlashDoppler_LE.m - Example of plane wave doppler imaging
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4FlashDoppler_LE';
...
save('MatFiles/L7-4FlashDoppler_LE');
return
