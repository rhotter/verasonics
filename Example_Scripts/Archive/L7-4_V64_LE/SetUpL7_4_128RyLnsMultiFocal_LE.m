...
%   for its use
%
% File name: SetUpL7_4_128RyLnsMultiFocal_LE.m - Imaging with dynamic focus transmits
%
% Description:
...
Resource.DisplayWindow.Title = 'L7-4_128RyLnsMultiFocal_LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:nr                     % Acquire frame
        w = 2*fz*(j-1);
        %Acquire all focal zones in assending order overwriting previous
...
save('MatFiles/L7-4_128RyLnsMultiFocal_LE');
