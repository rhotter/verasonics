...
%   for its use
%
% File name: SetUpL7_4FlashExtFunc_LE.m - Example of using external processing
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4FlashExtFunc_LE';
...
save('MatFiles/L7-4FlashExtFunc_LE');
return
