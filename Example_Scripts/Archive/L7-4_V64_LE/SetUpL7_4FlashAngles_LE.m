...
%   for its use
%
% File name: SetUpL7_4FlashAngles_LE.m - Example of plane wave imaing with
...
Resource.DisplayWindow(1).Title = 'L7-4FlashAngles_LE';
...
save('MatFiles/L7-4FlashAngles_LE');
return
