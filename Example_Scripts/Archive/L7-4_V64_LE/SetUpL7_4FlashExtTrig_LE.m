...
%   for its use
%
% File name: SetUpL7_4FlashExtTrig_LE.m - Example of acquisition with ExtTrig
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4FlashExtTrig_LE';
...
save('MatFiles/L7-4FlashExtTrig_LE');
return
