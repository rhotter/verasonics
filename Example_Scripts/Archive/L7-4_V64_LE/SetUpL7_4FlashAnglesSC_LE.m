...
%   for its use
%
% File name: SetUpL7_4FlashAnglesSC_LE.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L7-4FlashAnglesSC_LE';
...
save('MatFiles/L7-4FlashAnglesSC_LE');
return
