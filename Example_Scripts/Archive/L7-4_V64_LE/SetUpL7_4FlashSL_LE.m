...
%   for its use
%
% File name: SetUpL7_4FlashSL_LE.m - Plane wave transmit with steered linear array
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4FlashSL_LE';
