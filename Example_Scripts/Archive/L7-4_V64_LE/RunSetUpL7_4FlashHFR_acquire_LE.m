...
%   for its use
%
% File name: RunSetUpL7_4FlashHFR_acquire_LE.m - "High Frame Rate" acquisition for ultrafast imaging (script 1 of 2).
%
% Description:
...
P.numFrames = 6;      % no. of Receive frames (real-time images are produced 1 per frame)
...
Receive = repmat(struct('Apod', zeros(1,Trans.numelements), ...
                        ...
                        'sampleMode', 'NS200BW', ...
                        'mode', 0, ...
                        'callMediaFunc', 0), 1,2*P.numFrames*P.numAcqs);  % movepoints EVERY acquisition to illustrate superframe concept
                                                                    % real-time images will look "jerky" but using the reconstructAll script,                                                                    % playback process all acquisitions and shows smooth displacement
m = P.numAcqs;
...
RunSetUpL7_4FlashHFR_reconAll_LE    % be sure that simulateMode=2 in that script!!!
