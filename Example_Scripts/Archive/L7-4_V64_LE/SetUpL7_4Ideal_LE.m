...
%   for its use.
%
% File name: SetUpL7_4Ideal_LE.m - Example of imaging using ideal synthetic
%                                 aperture reconstruction
%
% Description:
%   Sequence programming file for L7-4 Linear array, using ideal synthetic
...
Resource.DisplayWindow(1).Title = 'L7-4Ideal_LE';
