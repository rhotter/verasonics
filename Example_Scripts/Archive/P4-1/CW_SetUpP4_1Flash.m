...
%   distance to the virtual apex. Procesing is asynchronous with respect
...
TW.type = 'parametric';
TW.Parameters = [Trans.frequency,.67,20,1];
...
TX.aperture = 1;  % this line was added
...
Receive = repmat(struct('Apod', zeros(1,96), ... % this line was added
...
SeqControl(2).argument = 100; % 10msec (~100fps)
