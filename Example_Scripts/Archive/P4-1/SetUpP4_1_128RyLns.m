...
%   for its use
%
% File name: SetUpP4_1_128RyLns.m - Example of phased array imaging with
%                                    focus transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'P4-1_128RyLns';
...
TGC.CntrlPts = [0,639,751,765,834,965,1023,1023];
