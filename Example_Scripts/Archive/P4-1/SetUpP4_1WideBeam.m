...
%   for its use.
%
% File name: SetUpP4_1WideBeam.m - Example of phased array imaging with
%                                   wide beam transmits
% Description:
...
%   asynchronous with respect to acquisition. Note: The P4-1 is a 96 element
...
P.aperture = Trans.numelements*Trans.spacing; % aperture based on 96 elements
...
Resource.DisplayWindow(1).Title = 'P4-1WideBeam';
...
Receive = repmat(struct('Apod', apod, ...
                        ...
                        'mode', 0, ...
                        'callMediaFunc', 0, ...
                        'aperture', 1),1,P.numRays*Resource.RcvBuffer(1).numFrames);
...
TGC.CntrlPts = [0,547,597,710,769,880,992,1023];
