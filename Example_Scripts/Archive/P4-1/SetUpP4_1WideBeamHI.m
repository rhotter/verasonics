...
%   for its use.
%
% File name: SetUpP4_1WideBeamHI.m - Example of phased array pulse inversion
...
%   Processing is asynchronous with respect to acquisition. Note: The P4-1
...
Resource.DisplayWindow(1).Title = 'P4-1WideBeamHI';
