...
%   for its use
%
% File name: SetUpL11_5vFlash_saveRFbutton.m
% Example of imaging with single plane wave transmit with a push button
% control to save RcvData in the workspace. This example script shows:
% 1) How to add a push button using UI.Control structure
% 2) How to save RF data after freeze. The RcvData will not be copied to
% Matlab workspace until freeze.
% The saved RcvData could be reprocessed using simulation mode 2 because
% the file size is not reduced by eliminating all zeros. The
% Resource.RcvBuffer.LastFrame is also saved for reference.
%
% Description:
...
% - Save RF Pushbutton
UI(3).Control = {'UserC1','Style','VsPushButton','Label','Save RF'};
UI(3).Callback = text2cell('%saveRFbutton');

% Specify factor for converting sequenceRate to frameRate.
frameRateFactor = 5;

% Save all the structures to a .mat file.
filename = 'L11-5vFlash_saveRF'; % used to launch VSX automatically
