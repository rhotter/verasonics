...
%   for its use.
%
% File name: SetUpP6_3WideBeamHI.m - Example of phased array pulse inversion
...
Resource.DisplayWindow(1).Title = 'P6-3WideBeamHI';
...
TGC.CntrlPts = [500,620,720,800,870,930,980,1023];
