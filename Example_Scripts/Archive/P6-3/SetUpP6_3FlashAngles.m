...
%   for its use.
%
% File name: SetUpP6_3FlashAngles.m - Example of phased array flash imaging
%                                       with multiple steering angles
% Description:
%   Sequence programming file for P6-3 phased array in virtual apex format,
%   using flash tranmists with multiple steering angles. All 128 transmit and
...
Resource.DisplayWindow(1).Title = 'P6-3FlashAngles';
...
TGC.CntrlPts = [0,445,510,604,635,691,756,824];
