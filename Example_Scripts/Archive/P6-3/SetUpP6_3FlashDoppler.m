...
%   for its use.
%
% File name: SetUpP6_3FlashDoppler.m - Example of phased array flash
%                                       Doppler imaging
% Description:
%   Sequence programming file for P6-3 phased array in virtual apex format,
%   using flash tranmists for 2D (B-mode) and doppler imaging. All 128 transmit
...
Resource.DisplayWindow(1).Title = 'P6-3FlashDoppler';
...
TW(2).Parameters = [4.464,0.67,6,1];
...
% - 2D TGC
TGC(1).CntrlPts = [100,601,649,710,769,880,940,971];
...
save('MatFiles/P6-3FlashDoppler');
return
