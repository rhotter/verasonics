...
%   for its use.
%
% File name SetUpCL15_7WideBeam.m:
% Generate .mat Sequence Object file for CL15_7 Linear array wide beam transmit.
...
Resource.DisplayWindow(1).Title = 'CL15-7WideBeam';
...
TW(1).Parameters = [5.9524,0.67,1,1];
...
TGC.CntrlPts = [0,179,700,760,874,1023,1023,1023];
