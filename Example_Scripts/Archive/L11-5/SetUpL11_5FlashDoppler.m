...
%   for its use
%
% File name: SetUpL11_5FlashDoppler.m - Example of plane wave doppler imaging
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5FlashDoppler';
...
% - 2D TGC
TGC(1).CntrlPts = [400,600,725,800,850,890,925,950];
TGC(1).rangeMax = P(1).endDepth;
TGC(1).Waveform = computeTGCWaveform(TGC(1));
% - Doppler TGC
TGC(2).CntrlPts = [400,625,780,875,925,925,925,925];
...
save('MatFiles/L11-5FlashDoppler');
return
