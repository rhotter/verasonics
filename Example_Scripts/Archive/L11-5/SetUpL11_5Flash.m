...
%   for its use
%
% File name: SetUpL11_5Flash.m - Example of imaging with single plane wave
%                                 transmit
% Description:
%   Sequence programming file for L11-5 Linear array, using a plane wave
...
Resource.DisplayWindow(1).Title = 'L11-5Flash';
...
TGC.CntrlPts = [450,590,700,800,875,925,950,975];
