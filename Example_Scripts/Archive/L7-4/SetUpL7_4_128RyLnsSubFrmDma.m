...
%   for its use
%
% File name: SetUpL7_4_128RyLnsSubFrmDma.m - Example of the sub-frame DMA
% feature
% Description:
%   This is a copy of the L7-4_128RyLns script, modified to add subframe
...
Resource.DisplayWindow(1).Title = 'L7-4_128RyLnsSubFrmDma';
...
for i = 1:Resource.RcvBuffer(1).numFrames
   ...
   % ****** Sub Frame *******
   % Insert two sub frame DMA transferToHost commands in the previous 128
   ...
   Event(n-79).seqControl = [1, nsc]; % DMA after 50th acquisition
       SeqControl(nsc).command = 'transferToHost'; % transfer frame to host buffer
       nsc = nsc+1;

   Event(n-34).seqControl = [1, nsc]; % DMA after 95th acquisition
       SeqControl(nsc).command = 'transferToHost'; % transfer frame to host buffer
       nsc = nsc+1;
...
save('MatFiles/L7-4_128RyLnsSubFrmDma');
