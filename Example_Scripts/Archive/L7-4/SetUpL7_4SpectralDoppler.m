...
%   for its use
%
% File name: SetUpL7_4SpectralDoppler.m - Spectral doppler with plane wave transmit.
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4SpectralDoppler';
...
save('MatFiles/L7-4SpectralDoppler');
return
