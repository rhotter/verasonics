...
%   for its use
%
% File name: SetUpL7_4FlashAnglesSC.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L7-4FlashAnglesSC';
...
TGC.CntrlPts = [0,227,331,488,616,729,899,997];
...
save('MatFiles/L7-4FlashAnglesSC');
return
