...
%   for its use.
%
% File name: SetUpL7_4Ideal.m - Example of imaging using ideal synthetic
...
Resource.RcvBuffer(1).rowsPerFrame = 1280*m; % 1280 samples ok for up to 240 wl range at 2 spw.
Resource.RcvBuffer(1).colsPerFrame = Resource.Parameters.numRcvChannels;
Resource.RcvBuffer(1).numFrames = 10;     % 10 frames for RF data.
Resource.InterBuffer(1).numFrames = 1;  % one intermediate buffer needed.
Resource.ImageBuffer(1).numFrames = 10;
Resource.DisplayWindow(1).Title = 'L7-4Ideal';
