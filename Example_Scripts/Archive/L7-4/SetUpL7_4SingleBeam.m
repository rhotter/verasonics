...
%   for its use.
%
% File name: SetUpL7_4SingleBeam.m - Example of imaging with single focused
%                                      beam transmit
% Description:
%   Sequence programming file for L7-4 Linear array, using single beam
%   focused transmit. 96 transmit and 128 receive channels are active for
%   each acquisition. Processing are synchronous with respect to acquisition.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'L7-4SingleBeam';
