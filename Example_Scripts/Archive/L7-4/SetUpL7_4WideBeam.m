...
%   for its use.
%
% File name SetUpL7_4WideBeam.m:
% Generate .mat Sequence Object file for L7_4 Linear array wide beam transmit.
...
Resource.DisplayWindow(1).Title = 'L7-4WideBeam';
...
TGC.CntrlPts = [0,317,403,489,604,649,771,836];
