...
%   for its use
%
% File name: SetUpL7_4WideBeamHI.m - Pulse inversion imaging with widebeam transmit
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L7-4WideBeamHI';
