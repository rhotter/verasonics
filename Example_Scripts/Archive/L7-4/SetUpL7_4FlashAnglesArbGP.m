...
%   for its use
%
% File name: SetUpL7_4FlashAnglesArbGP.m - Plane wave imaging with arbitrary
...
%   L7-4 scanhead, and applied to all element channels.
%   The resulting encoding was tested on a different L7-4 scanhead and found
%   to retain its effectiveness.  Results on other L7-4 scanheads may vary.
%
% Last update:
...
Resource.DisplayWindow(1).Title = ['L7-4FlashAnglesArbGP:',WFName];
...
save('MatFiles/L7-4FlashAnglesArbGP');
return
