...
%   for its use
%
% File name: SetUpL7_4FlashDopplerLF.m - Plane wave doppler imaging with
...
%   - for the 2D (B-mode) imaging, na steered angles are used. 128 transmit
...
%     128 transmit and 64 receive channels are active for each doppler ensemble.
...
Resource.DisplayWindow(1).Title = 'L7-4FlashDopplerLF';
...
save('MatFiles/L7-4FlashDopplerLF');
return
