...
%   for its use
%
% File name: SetUpL11_5vFlashAngles.m - Example of plane wave imaging with
...
filename = 'SetUpL11_5vFlashAngles_CustomGUI';
% Save all the structures to a .mat file.
save(['MatFiles/' filename ]);

% make sure you create a vsx aplication that will load your custom GUI
vsxApplication = vsv.apps.VSXResearchApp( 'vsCustomGUI' );
% VSX
