...
%   focusing reconstruction. Specifed digital inputs are read once per
%   frame and stored in buffer.
%
% Last update:
% 10/28/2020 
...
Resource.ExtIO.createDigitalInput(8); %creates 8 line digital port
Resource.ExtIO.DigitalInput.BufferSetting.BufferLength = 100; %length of buffer for encoder reads
Resource.ExtIO.DigitalInput.BufferSetting.BufferType = "Fixed"; %buffer type for encoder reads "Fixed" or "Circular"
...
save('MatFiles/ExtIO_DigitalInput');
...
% filename = 'ExtIO_DigitalInput'; VSX;
