...
%   for its use
%
% File name: SetUpL11_5vFlashSync.m - Plane wave imaging with Recon/processing
%                                     synchronised with acquisition
%
% Description:
%   Sequence programming file for L11-5v Linear array, using a plane wave
%   transmit and single receive acquisition synchronised to software
%   reconstruction/processing sequences. All 128 transmit and receive
%   channels are active for each acquisition.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashSync';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    % -- full aperture acquisition for a frame
