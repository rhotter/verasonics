...
%   for its use
%
% File name: SetUpL11_5vFlashAccum.m - Example of plane wave imaging by accumulating
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAccum';
...
UI(2).Control = VsSliderControl('LocationCode','UserA1',...
    'Label',['Range (',AxesUnit,')'],'SliderMinMaxVal',...
    MinMaxVal,'SliderStep',[0.1,0.2],'ValueFormat','%3.0f',...
...
save('MatFiles/L11-5vFlashAccum');
