...
UI(2).Control = VsSliderControl(...
    'LocationCode','UserA1','Label',['Range (',AxesUnit,')'],...
...
UI(3).Control = VsSliderControl(...
    'LocationCode','UserB4','Label',['TX Focus (',AxesUnit,')'],...
...
UI(4).Control = VsSliderControl(...
    'LocationCode','UserB3','Label','F Number',...
...
save('MatFiles/L11-5v_128RyLnsSubFrmDma');
...
% filename = 'L11-5v_128RyLnsSubFrmDma';  VSX;
