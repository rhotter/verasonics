...
%   for its use
%
% File name: SetUpL11_5vFlashExtFunc_64LE.m - Example of using external processing
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashExtFunc_64LE';
...
save('MatFiles/L11-5vFlashExtFunc_64LE');
...
% filename = 'L11-5vFlashExtFunc_64LE';  VSX;
