...
%   for its use
%
% File name: SetUpL11_5vFlashAccum_64LE.m - Example of plane wave imaging by accumulating
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAccum_64LE';
...
Receive = repmat(struct('Apod', zeros(1,Trans.numelements), ...
                        ...
                        'sampleMode', 'NS200BW', ...
                        'mode', 1, ...
                        'callMediaFunc', 0),1,4*Resource.RcvBuffer(1).numFrames);
...
ReconInfo = repmat(struct('mode', 'replaceIntensity', ...
                   'txnum', 1, ...
                   'rcvnum', 1, ...
                   'regionnum', 1),1,2); % initialize two ReconInfo for synthetic aperture
% Unique values for second ReconInfo:
...
save('MatFiles/L11-5vFlashAccum_64LE');
...
% filename = 'L11-5vFlashAccum_64LE';  VSX;
