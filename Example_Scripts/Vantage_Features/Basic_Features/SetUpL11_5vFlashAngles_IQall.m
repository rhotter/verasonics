...
%   for its use
%
% File name: SetUpL11_5vFlashAngles_IQall.m - Example of plane wave imaging with
...
%   with respect to acquisition. With the definition of the pagesPerFrame in the
%   InterBuffer, the IQ data of each acquisition will be stored in the IData and QData.
%
% Last update:
...
% 06/25/2019 - Support auto-increment feature of the IQBuffer
...
Resource.InterBuffer(1).numFrames = 30;   % one intermediate buffer needed.
...
save('MatFiles/L11-5vFlashAngles_IQall');
...
% filename = 'L11-5vFlashAngles_IQall';  VSX;
