...
%   for its use
%
% File name: SetUpL11_5vFlashExtFunc.m - Example of using external processing
%
% Description:
...
Resource.RcvBuffer(1).numFrames = 10;         % frames used for RF cineloop.
Resource.InterBuffer(1).numFrames = 1;  % one intermediate buffer needed.
Resource.ImageBuffer(1).numFrames = 10;
Resource.DisplayWindow(1).Title = 'L11-5vFlashExtFunc';
...
UI(3).Control = VsSliderControl('LocationCode','UserB2',...
    'Label','Element No.','SliderMinMaxVal',[1,128,64],...
    'SliderStep',[1/128,1/16],'ValueFormat','%3.0f',...
...
save('MatFiles/L11-5vFlashExtFunc');
...
% filename = 'L11-5vFlashExtFunc';  VSX;
