...
Fc = 7.57;                   % This is the compromise shared
% frequency to be used by both L12-3v (7.54 MHz) and L11-5v (7.6 MHz)
% ---------------------------------------------------------------
...
TX(3).Steer = [0,0];
TX(3).Apod = [zeros(1, 128), ones(1,128)]; % ***Dual Xdcr*** L11-5v uses channels 129:256
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    % Receive(3*i) will be for the L11-5v.
...
% Define ReconInfo structure for L11-5v using same approach as for Recon.
