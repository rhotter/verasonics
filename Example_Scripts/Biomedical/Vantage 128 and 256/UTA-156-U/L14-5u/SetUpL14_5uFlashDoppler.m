...
%   for its use
%
% File name: SetUpL14_5uFlashDoppler.m - Example of plane wave doppler imaging
%
% Description:
%   Sequence programming file for L14-5u Linear array, using plane wave
...
Trans.id = 0;
Trans.frequency = 7.81;
Trans.Bandwidth = Trans.frequency*[0.7, 1.3]; % default assumed value of 60% of center frequency
...
Trans.elevationApertureMm = 4; % (mm) active elevation aperture (spec)
Trans.elevationFocusMm = 16; % (mm) nominal elevation focus depth from lens on face of transducer (spec)
...
Trans.lensCorrection = 0; % in mm units; was 5 wavelengths
Trans.impedance = 50;
...
Resource.DisplayWindow(1).Title = 'L14-5uFlashDoppler';
...
save('MatFiles/L14-5uFlashDoppler');
return
