...
%   for its use
%
% File name: SetUpL14_5uFlash.m - Example of imaging with single plane wave
%                                 transmit
% Description:
%   Sequence programming file for L14-5u Linear array, using a plane wave
...
Resource.DisplayWindow(1).Title = 'L14-5uFlash';
