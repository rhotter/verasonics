...
%   for its use
%
% File name: SetUpL22_14vXFlashAngles67BW.m.m - Example of plane imaging with multiple steering angle
%                                               transmits, and with 67% bandwidth sampling (4/3x).
% Description:
%   Sequence programming file for L22-14vX Linear array, using a plane wave
%   transmit with multiple steering angles. All 128 transmit and receive
%   channels are active for each acquisition. This script uses 4/3 sampling
...
%   MHz processing center frequency. Transmit is at 17.8 MHz. Processing is
...
Resource.DisplayWindow(1).Title = 'L22-14vXFlashAngles67BW, 4/3 sampling at 25 MHz, 50 MHz A/D';
...
save('MatFiles/L22-14vXFlashAngles67BW');
return
