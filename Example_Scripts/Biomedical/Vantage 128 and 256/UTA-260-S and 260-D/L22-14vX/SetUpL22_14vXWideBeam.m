...
%   for its use
%
% File name: SetUpL22_14vXWideBeam.m - Example of imaging with partially focused "wide beam" transmits
%
% Description:
%   Sequence programming file for L22-14vX Linear array, using numrays widebeam
...
%   the L22-14vX (18MHz center frequency, 67% bandwidth). Processing is
...
Trans = computeTrans(Trans);  % L22-14vX transducer is 'known' transducer so we can use computeTrans.
...
Resource.DisplayWindow(1).Title = 'L22-14vX Wide Beam, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14vXWideBeam');
