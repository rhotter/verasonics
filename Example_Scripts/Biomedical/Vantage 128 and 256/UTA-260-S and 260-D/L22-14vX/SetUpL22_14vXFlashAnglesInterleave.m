...
%   for its use
%
% File name: SetUpL22_14vXFlashAnglesInterleave.m
...
%   data acquisition.  In this script, the L22-14vX is operated at a nominal
...
%   acquisition at 83.3 MHz, this script is identical to L22-14vXFlashAngles
...
Resource.DisplayWindow(1).Title = 'L22-14vX FlashAngles Interleave, 4X sampling at 83 MHz';
...
% Note that for the L22-14vX we would ideally use a bandpass filter centered
...
save('MatFiles/L22-14vXFlashAnglesInterleave');
return
