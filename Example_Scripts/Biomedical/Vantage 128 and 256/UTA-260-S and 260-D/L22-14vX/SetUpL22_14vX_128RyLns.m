...
Resource.DisplayWindow.Title = 'L22-14vX128RyLns 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14vX_128RyLns');
% filename = ('L22-14vX_128RyLns'); % VSX    % permits immediately running VSX without specifying the matfile name
return
