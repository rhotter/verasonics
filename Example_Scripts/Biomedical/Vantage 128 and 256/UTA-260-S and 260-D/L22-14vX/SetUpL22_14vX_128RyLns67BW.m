...
%   for its use
%
% File name: SetUpL22_14v128RyLns67BW.m - Example of scanline imaging with focused transmits, and 4/3rds sampling.
%
% Description:
%   Sequence programming file for L22-14vX Linear array, using 128 ray lines
...
%   transmit focus depth and f-number. All 128 receive channels are active for
%   each acquisition. This script uses 4/3 sampling with A/D sample rate of
%   50 MHz followed by a highpass filter and subsampling by 2, to produce
%   the 25 MHz output sample rate with 18.75 MHz processing center
%   frequency. Transmit is at 17.8 MHz. Processing is asynchronous with
...
Trans.frequency = 18.75; % processing center frequency in megahertz
...
Resource.DisplayWindow.Title = 'L22-14vX128RyLns67BW, 4/3 sampling at 25 MHz, 50 MHz A/D';
...
wlsPer128 = 128/(4/3*2); % wavelengths in 128 samples for 4/3 samplesPerWave
...
TGC.CntrlPts = [0,511,716,920,1023,1023,1023,1023]; %[0,138,260,287,385,593,674,810];
...
save('MatFiles/L22-14vX_128RyLns67BW');
return
