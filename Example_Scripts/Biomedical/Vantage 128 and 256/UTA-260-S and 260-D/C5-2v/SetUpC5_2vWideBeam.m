...
%   for its use.
%
% File name: SetUpC5_2vWideBeam.m - Example of curved array imaging with
%                                   wide beam transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeam';
