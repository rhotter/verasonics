...
%   for its use
%
% File name: SetUpC5_2vFlashDopplerLF.m - Example of curved array flash
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashDopplerLF';
...
save('MatFiles/C5-2vFlashDopplerLF');
...
% filename = 'C5-2vFlashDopplerLF';  VSX;
