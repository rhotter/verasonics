...
%   for its use
%
% File name: SetUpC5_2vFlashAngles.m - Example of curved array flash imaging
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashAngles';
...
save('MatFiles/C5-2vFlashAngles');
