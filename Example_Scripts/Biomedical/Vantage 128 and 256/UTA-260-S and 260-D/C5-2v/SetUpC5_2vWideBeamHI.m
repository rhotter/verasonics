...
%   for its use.
%
% File name: SetUpC5_2vWideBeamHI.m - Example of curved array imaging with
%                                   wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for C5-2v curved array using widebeam pulse
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeamHI';
