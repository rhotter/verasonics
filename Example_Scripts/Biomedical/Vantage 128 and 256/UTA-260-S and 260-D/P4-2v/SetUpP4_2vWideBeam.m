...
%   for its use.
%
% File name: SetUpP4_2vWideBeam.m - Example of phased array imaging with
%                                   wide beam transmits
% Description:
...
%   asynchronous with respect to acquisition. Note: The P4-2v
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeam';
