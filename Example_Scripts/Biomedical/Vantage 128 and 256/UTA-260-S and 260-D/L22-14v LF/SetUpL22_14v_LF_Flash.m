...
%   for its use
%
% File name: SetUpL22_14v_LF_Flash.m - Example of plane wave imaging using a single wavefront angle.
%
% Description:
%   Sequence programming file for L22-14v LF linear array, using a plane
%   wave transmit and single receive acquisitions.  Note the L22-14v LF is
%   very similar to the L22-14v but has a deeper elevation focus.  All 128
...
%   dB bandwidth to support the 12 MHz bandwidth of the L22-14vLF (18MHz
%   center frequency, 67% bandwidth). Processing is asynchronous with
%   respect to acquisition.
%
% Last update:
% 12/7/2015 - modified for SW 3.0
...
Resource.DisplayWindow(1).Title = 'L22-14v LF Flash, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14v_LF_Flash');
return
