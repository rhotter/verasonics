...
%   for its use
%
% File name: SetUpL11_4vFlashDopplerLF.m - Plane wave doppler imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashDopplerLF';
...
save('MatFiles/L11-4vFlashDopplerLF');
return
