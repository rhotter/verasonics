...
%   for its use
%
% File name: SetUpL11_4vWideBeamHI.m - Pulse inversion imaging with widebeam transmit
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-4vWideBeamHI';
...
save('MatFiles/L11-4vWideBeamHI');
