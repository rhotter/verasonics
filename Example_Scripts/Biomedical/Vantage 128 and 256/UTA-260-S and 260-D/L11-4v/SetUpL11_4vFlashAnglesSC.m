...
%   for its use
%
% File name: SetUpL11_4vFlashAnglesSC.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashAnglesSC';
...
save('MatFiles/L11-4vFlashAnglesSC');
return
