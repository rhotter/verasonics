...
%   for its use
%
% File name: RunSetUpL11_4vFlashHFR_acquire.m - "High Frame Rate" acquisition for ultrafast imaging (script 1 of 2).
%
% Description:
...
filename = 'L11-4vFlashHFR_acq'; % used to launch VSX automatically
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashHFR';
...
RunSetUpL11_4vFlashHFR_reconAll    % be sure that simulateMode=2 in that script!!!
