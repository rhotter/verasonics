...
%   for its use
%
% File name: SetUpL22_8v_256RyLns.m - Example of 256 ray line imaging
%                                        with single focal zone.
% Description:
...
P.endDepth = 200;
P.numRays = 256;
P.numTx = 25;    % number of active transmitters in TX aperture.
...
Resource.DisplayWindow(1).Title = 'L22-8v_256RyLns';
...
SeqControl(2).argument = 400; % 400 usec
