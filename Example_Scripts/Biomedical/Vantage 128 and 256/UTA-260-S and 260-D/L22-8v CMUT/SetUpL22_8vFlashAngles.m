...
Resource.RcvBuffer(1).rowsPerFrame = 4096*3*na; % this size allows for 3 acqs for each angle, maximum range
...
Resource.DisplayWindow(1).Title = 'L22-8vFlashAngles';
...
save('MatFiles/L22-8vFlashAngles');
return
