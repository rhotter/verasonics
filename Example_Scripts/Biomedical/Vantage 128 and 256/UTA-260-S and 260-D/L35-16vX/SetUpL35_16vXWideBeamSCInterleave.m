...
%   for its use.
%
% File name SetUpL35_16vXWideBeamSCInterleave.m:
%    Generate .mat Sequence Object file for L35-16vX Linear array wide beam scan,
%    with 3 steering angles for spatial compounding using 4X interleaved sampling.
...
%
% Last update: 10/30/17 Working with release 3.3 and higher.
%
...
Resource.DisplayWindow(1).Title = 'L35-16vX WideBeamSC, Interleaved Sampling';
...
save('MatFiles/L35-16vXWideBeamSCInterleave');
