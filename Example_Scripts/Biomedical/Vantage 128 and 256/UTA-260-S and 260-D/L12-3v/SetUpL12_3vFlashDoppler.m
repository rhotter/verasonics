...
%   for its use
%
% File name: SetUpL12_3vFlashDoppler.m - Example of 2-1 synthetic aperture plane
%                                       wave doppler imaging with steering angle transmits
% Description:
%   Sequence programming file for L12-3v Linear array, using 2-1 synthetic
%   aperture plane wave transmits on a 128 channel system for 2D (B-mode) and
%   doppler imaging.

%   For B-Mode images, 128 transmit channels and 96 receive channels are
...
%
%   For doppler images, 128 transmit channels and 128 receive channels are
...
Resource.RcvBuffer(1).rowsPerFrame = 4096*(2*na+ne); % this size allows for 2 acqs per angle and all doppler acquisitions, maximum range
...
Resource.DisplayWindow(1).Title = 'L12-3vFlashDoppler';
...
save('MatFiles/L12-3vFlashDoppler');
return
