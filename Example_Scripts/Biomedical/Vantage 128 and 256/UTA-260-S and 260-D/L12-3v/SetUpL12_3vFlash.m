...
%   for its use
%
% File name: SetUpL12_3vFlash.m - Example of 2-1 synthetic aperture plane
%                                 wave imaging with single transmit
% Description:
%   Sequence programming file for L12-3v Linear array, using 2-1 synthetic
%   aperture plane wave transmits and receive acquisitions on a 128 channel
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', 0.0, ...
                   'Steer', [0.0,0.0], ...
                   'Delay', zeros(1,Resource.Parameters.numTransmit)), 1, 2);
