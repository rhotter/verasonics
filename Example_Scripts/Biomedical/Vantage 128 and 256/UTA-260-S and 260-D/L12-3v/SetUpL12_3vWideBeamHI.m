...
%   for its use
%
% File name SetUpL12_3vWideBeamHI.m: pulse inversion imaging with widebeam
% transmit
%
% Description:
%   Create widebeam pulse inversion sequence for L12-3v 38mm Linear array on Vantage system.
%
...
Resource.DisplayWindow(1).Title = 'L12-3vWideBeamHI';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:P.numRays
        Receive(2*P.numRays*(i-1)+j).aperture = TX(j).aperture; % aperture same as transmit
    ...
    for j = 1:P.numRays
        ...
        Receive(2*P.numRays*(i-1)+j+k).aperture = TX(j).aperture; % aperture same as transmit
...
save('MatFiles/L12-3vWideBeamHI');
