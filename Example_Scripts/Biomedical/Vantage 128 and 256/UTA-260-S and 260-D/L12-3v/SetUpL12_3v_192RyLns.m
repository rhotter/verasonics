...
%   for its use
%
% File name SetUpL12_3v_192RyLns.m:Example of 192 ray line imaging
%
% Description:
%   Create line mode sequence for L12-3v 38mm Linear array on Vantage system. The number
%   of ray lines is set by the variable 'numRays', with the rays evenly distributed across
%   the full aperture.  The number of active transmitters is set by the variable 'numTx',
...
Resource.DisplayWindow(1).Title = 'L12-3v_192RyLns';
