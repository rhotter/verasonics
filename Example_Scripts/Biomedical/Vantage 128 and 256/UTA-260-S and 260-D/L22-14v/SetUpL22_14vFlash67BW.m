...
%   for its use
%
% File name: SetUpL22_14vFlash67BW.m.m - Example of plane wave imaging with 4/3 sampling (67% bandwidth sampling).
%
% Description:
%   Sequence programming file for L22-14v Linear array, using a plane wave
%   transmit and single receive acquisitions. All 128 transmit and receive
...
Resource.DisplayWindow(1).Title = 'L22-14vLF Flash, 4/3 sampling at 25 MHz, 50 MHz A/D';
...
save('MatFiles/L22-14vFlash67BW');
return
