...
%   for its use.
%
% File name: SetUpIP105WideBeamHIPolar.m - Example of phased array pulse inversion
...
P.numRays = 64; % no. of raylines to program
P.startDepth = 0;
P.endDepth = 70*mm2wl;  % Acquisition depth in wavelengths
...
save('MatFiles/IP105WideBeamHIPolar');
return
