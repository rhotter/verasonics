...
%   for its use.
%
% File name: SetUpIP105Flash.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
%   Sequence programming file for IP-105 phased array in virtual apex format,
...
%   to acquisition. Note: The IP-105 is a 64 element probe that is wired to
...
%
% Last update:
% 11/16/2017 testing with 3.4.0 SW and UTA 260-S on Vantage 64
...
Resource.DisplayWindow(1).Title = 'IP-105Flash';
...
Control = evalin('base','Control');
Control.Command = 'update&Run';
Control.Parameters = {'PData','InterBuffer','ImageBuffer','DisplayWindow','TGC','Receive','Recon'};
assignin('base','Control', Control);
