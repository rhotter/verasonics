...
%   for its use
%
% File name: SetUpIP105WideBeamDopplerNew.m - Example of WideBeam doppler
% imaging used in Clinical Application
%
% Description:
%   Sequence programming file for IP105 Phase array, using WideBeam
...
%   06/15/2021 - Extensive modifications for FUS Elite 3000 3D.
...
%           ^
%         array
%   -----|=====|----- <- z=0, P.startDepthMm, P.dopStartDepthMm, P.startPDataMm
%   |    /<--->\    | <- P.scanAngle
%   |   /       \   |
%   |  /   ---   \  | <- P.dopTopColorBoxMm
%   | /   /clr\   \ |
...
P.dopStartDepthMm = 0;
P.startPDataMm = 0;      % depth of top of PData region
P.dopTopColorBoxMm = 50;
P.dopBottomColorBoxMm = P.dopTopColorBoxMm + 30;
...
demodFreq = 4.8077;  % Doppler demodulation frequency 
...
Resource.DisplayWindow(1).Title = 'IP105WideBeamDoppler';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = (P.numRays+1):(P.numRays+P.dopPRIs*P.dopNumRays)
        % Doppler acquisition
        Receive(j+k).startDepth = dopStartDepth;
...
save('MatFiles/IP105WideBeamDopplerNew');
...
% filename = 'IP105WideBeamDoppler';  VSX;
