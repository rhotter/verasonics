...
%   for its use
%
% File name: SetUpL22_14vX_LF_Flash.m - Example of plane wave imaging using a single wavefront angle.
%
% Description:
%   Sequence programming file for L22-14vX LF linear array, using a plane
%   wave transmit and single receive acquisitions.  Note the L22-14vX LF is
%   very similar to the L22-14vX but has a deeper elevation focus.  All 128
%   transmit and receive channels are active for each acquisition. This
%   script uses 4X sampling with A/D sample rate of 62.5 MHz for a 15.625
%   MHz processing center frequency.  Transmit is at 17.8 MHz and receive
%   bandpass filter has been shifted to 18 MHz center frequency, 13.9MHz -3
%   dB bandwidth to support the 12 MHz bandwidth of the L22-14vX LF (18MHz
%   center frequency, 67% bandwidth). Processing is asynchronous with
...
Resource.DisplayWindow(1).Title = 'L22-14vX LF Flash, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14vX_LF_Flash');
return
