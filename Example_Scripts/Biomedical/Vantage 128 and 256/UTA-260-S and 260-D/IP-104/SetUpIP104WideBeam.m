...
%   for its use.
%
% File name: SetUpIP104WideBeam.m - Example of phased array imaging with
%                                   wide beam transmits
...
Resource.System.Frequency = 'HIFU';
...
P.startDepth = 5;
P.endDepthMm = 100;  % endDepth in mm
P.endDepth = P.endDepthMm*scaleToWvl;   % Acquisition depth in wavelengths
P.txFocus = 900;
...
Resource.DisplayWindow(1).Title = 'IP104WideBeam';
...
Process(1).Parameters = {'imgbufnum',1,...   % number of buffer to process.
                         ...
                         'pgain',15,...            % pgain is image processing gain
...
SeqControl(3).argument = 20000 - (P.numRays-1)*260;
...
% - Range Change
MinMaxVal = [P.startDepth,P.endDepth,P.endDepth]; % default unit is wavelength
AxesUnit = 'wls';
