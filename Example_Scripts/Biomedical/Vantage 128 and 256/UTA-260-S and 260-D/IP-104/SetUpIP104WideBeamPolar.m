...
%   for its use.
%
% File name: SetUpIP104WideBeamPolar.m - Example of phased array imaging with
...
%
% Last update:
%   10-11-2017 modify to use with IP104
...
Trans.maxHighVoltage = 1.6;  % set maximum high voltage limit for pulser supply.
...
Resource.DisplayWindow(1).Title = 'IP104WideBeamPolar';
...
SeqControl(3).argument = 25000 - (P.numRays/2-1)*260;
...
save('MatFiles/IP104WideBeamPolar');
return
