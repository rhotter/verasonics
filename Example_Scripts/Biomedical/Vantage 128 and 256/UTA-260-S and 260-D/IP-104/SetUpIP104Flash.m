...
%   for its use.
%
% File name: SetUpIP-104Flash.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
...
%
% Last update:
% 07/13/2017 testing with SW 3.2.2 in simulation mode
...
Resource.DisplayWindow(1).Title = 'IP-104Flash';
