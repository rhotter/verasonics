...
%   for its use
%
% File name: SetUpL11_5vSpectralDoppler.m - Spectral doppler with plane wave transmit.
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5vSpectralDoppler';
...
save('MatFiles/L11-5vSpectralDoppler');
