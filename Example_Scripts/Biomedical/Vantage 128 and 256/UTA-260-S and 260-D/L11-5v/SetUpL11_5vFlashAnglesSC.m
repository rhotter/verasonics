...
%   for its use
%
% File name: SetUpL11_5vFlashAnglesSC.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAnglesSC';
...
save('MatFiles/L11-5vFlashAnglesSC');
return
