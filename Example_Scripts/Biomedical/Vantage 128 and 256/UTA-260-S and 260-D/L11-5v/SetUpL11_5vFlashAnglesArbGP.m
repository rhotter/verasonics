...
%   for its use
%
% File name: SetUpL11_5vFlashAnglesArbGP.m - Plane wave imaging with arbitrary
...
%   L11-5v scanhead, and applied to all element channels.
%   The resulting encoding was tested on a different L11-5v scanhead and found
%   to retain its effectiveness.  Results on other L11-5v scanheads may vary.
%
% Last update:
...
Resource.DisplayWindow(1).Title = ['L11-5vFlashAnglesArbGP:',WFName];
...
save('MatFiles/L11-5vFlashAnglesArbGP');
return
