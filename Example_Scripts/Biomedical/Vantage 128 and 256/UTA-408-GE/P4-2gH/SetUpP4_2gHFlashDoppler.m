...
%   for its use.
%
% File name: SetUpP4_2gHFlashDoppler.m - Example of phased array flash
%                                       Doppler imaging
% Description:
...
% 09/24/2021 - modifeied for P4-2gH
...
Resource.DisplayWindow(1).Title = 'P4-2gHFlashDoppler';
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', -P(1).radius, ...
                   'Steer', [0.0,0.0], ...
                   'Apod', ones(1,96), ...  % set TX.Apod for 94 elements
...
save('MatFiles/P4-2gHFlashDoppler');
