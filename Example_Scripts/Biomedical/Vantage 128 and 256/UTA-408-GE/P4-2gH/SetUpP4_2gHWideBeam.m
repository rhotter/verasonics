...
%   for its use.
%
% File name: SetUpP4_2gHWideBeam.m - Example of phased array imaging with
%                                   wide beam transmits
% Description:
...
%   asynchronous with respect to acquisition. Note: The P4-2gH
%   is a 96 element probe that is wired to the scanhead connector with
%   elements 1-64 connected to inputs 1-96. We therefore need a Trans.Connector
...
Resource.DisplayWindow(1).Title = 'P4-2gHWideBeam';
...
UI(3).Control = VsSliderControl('LocationCode','UserB2',...
    'Label','Peak Cutoff',...
    'SliderMinMaxVal',[0,5.0,TX(1).peakCutOff],...
