...
%   for its use.
%
% File name: SetUpP4_2gHFlash.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
...
% 09/24/2021 - modifed for P4-2gH from P4-2v
...
Resource.DisplayWindow(1).Title = 'P4-2gHFlash';
...
TX.Steer = [0,0];
TX.Apod = ones(1,96);  % set TX.Apod for 96 elements
