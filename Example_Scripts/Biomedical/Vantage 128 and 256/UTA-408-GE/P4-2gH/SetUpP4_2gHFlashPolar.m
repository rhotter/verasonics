...
%   for its use.
%
% File name: SetUpP4_2gHFlashPolar.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
...
%
% 09/24/2021 - modified for P4-2gH from P4-2v script
...
Resource.DisplayWindow(1).Title = 'P4-2gHFlashPolar';
...
TX.Steer = [0,0];
TX.Apod = ones(1,96);  % set TX.Apod for 64 elements
...
save('MatFiles/P4-2gHFlashPolar');
