...
%   for its use.
%
% File name: SetUpP4_2gHWideBeamHI.m - Example of phased array pulse inversion
...
%   elements 1-96 connected to inputs 1-96. We therefore need a Trans.Connector
%   array to specify the connector channels used, which will be defined by
%   the computeTrans function.
%
% Last update:
% 9/27/2021 modified for P4-2gH
...
Resource.DisplayWindow(1).Title = 'P4-2gHWideBeamHI';
...
UI(5).Control = VsSliderControl('LocationCode','UserC2',...
    'Label','Reg. Width',...
...
save('MatFiles/P4-2gHWideBeamHI');
