...
%   for its use
%
% File name: SetUpP4_2gH_128RyLns.m - Example of phased array imaging with
%                                    focus transmits
% Description:
...
%   array to specify the connector channels used, which will be defined by the
%   Trans function.
%
% Last update:
% 11/13/2015 - modified for SW 3.0
...
Resource.DisplayWindow(1).Title = 'P4-2gH_128RyLns';
