...
%   for its use.
%
% File name: SetUpGEM5ScD_WideBeamPolar.m - Example of phased array imaging with 128 ray lines.
%
% Description:
...
%
% Last update:
%   10/04/2017 - first working version
...
TW.type = 'parametric';
TW.Parameters = [3.2895,.67,2,1];   % A, B, C, D
...
save('MatFiles/GEM5ScD_WideBeamPolar');
return
