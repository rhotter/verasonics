...
%   for its use.
%
% File name SetUpL39_21gDFlashAnglesI.m 
%   This script is derived from SetUpL39_16vXFlashAnglesInterleave.m.
%
% Description: Using same interleaved sampling as the L35_16vX script but
%   with demod frequency and transmit frequency set to 31.25 MHz
%
% Last Update
...
Resource.DisplayWindow(1).Title = 'L39-21gD, 128 EL Flash Angles, Interleaved Sampling';
...
save('MatFiles/L39-21gDFlashAnglesInterleave');
% filename=('L39-21gDFlashAnglesInterleave'); VSX
