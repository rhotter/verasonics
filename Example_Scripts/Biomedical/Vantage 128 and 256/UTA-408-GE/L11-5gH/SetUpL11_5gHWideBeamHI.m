...
%   for its use
%
% File name: SetUpL11_5gHWideBeamHI.m - Pulse inversion imaging with widebeam transmit
%
% Description:
%   Sequence programming file for L11-5gH Linear array, using widebeam pulse
%   inversion transmits and receive acquisitions. The transmit aperture size
%   is set by the variable - numTx, and the number of pulse-inversion transmits
%   are set by the variable - numRays. All 128 receive channels are active
%   for each acquisition. Processing is asynchronous with respect to acquisition.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'L11-5gHWideBeamHI';
...
save('MatFiles/L11-5gHWideBeamHI');
...
% filename = 'L11-5gHWideBeamHI';  VSX;
