...
%   for its use
%
% File name: SetUpL11_5gHFlashAnglesSC.m - Plane wave transmits with steering
%                                         angles and spatial compounding
% Description:
%   Sequence programming file for L11-5gH Linear array, using plane wave
%   transmits with multiple steering angles and spatial compouding over 3
...
% set dtheta to range over +/- 20 degrees.
if (na > 1)
  dtheta = (40*pi/180)/(na-1);
  startAngle = -40*pi/180/2;
else
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashAnglesSC';
...
save('MatFiles/L11-5gHFlashAnglesSC');


% **** Callback routines used by UIs. ****
