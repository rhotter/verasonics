...
%   for its use
%
% File name: RunSetUpL11_5gHFlashHFR_acquire.m - "High Frame Rate" acquisition for ultrafast imaging (script 1 of 2).
%
% Description:
...
%   using the previously collected data. That script, SetUpL11_4vFlashHFR_reconAll.m, reconstructs and displays all
...
filename = 'L11-5gHFlashHFR_acq'; % used to launch VSX automatically
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashHFR';
...
RunSetUpL11_5gHFlashHFR_reconAll    % be sure that simulateMode=2 in that script!!!
