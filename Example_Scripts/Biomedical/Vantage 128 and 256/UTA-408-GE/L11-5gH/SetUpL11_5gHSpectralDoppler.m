...
%   for its use
%
% File name: SetUpL11_5gHSpectralDoppler.m - Spectral doppler with plane wave transmit.
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5gHSpectralDoppler';
...
SeqControl(5).argument = [];  % jump to start of acquisition, will be modified later
...
nStartAcq = n;
SeqControl(5).argument = nStartAcq;
...
UI(2).Control = VsSliderControl( 'LocationCode', 'UserA1','Style','VsSlider','Label',['Range (',AxesUnit,')'],...
                 'SliderMinMaxVal',MinMaxVal,'SliderStep',[0.1,0.2],'ValueFormat','%3.0f', ...
                 'Callback', @rangeChangeCallback);

% - PRF control
UI(3).Control =  VsSliderControl( 'LocationCode', 'UserB4','Style','VsSlider','Label','Doppler PRF',...
...
% - Wall Filter control
UI(4).Control =  VsSliderControl( 'LocationCode','UserB3','Style','VsSlider','Label','Doppler WF',...
...
% - Sweep Time control
UI(5).Control = VsSliderControl('LocationCode', 'UserB2','Style','VsSlider','Label','Sweep Time',...
...
% - Baseline control
UI(6).Control =  VsSliderControl('LocationCode', 'UserB1','Style','VsSlider','Label','Baseline',...
...
save('MatFiles/L11-5gHSpectralDoppler');
