...
%   for its use
%
% File name: SetUpL11_5gHFlashDoppler.m - Example of plane wave doppler imaging
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashDoppler';
...
save('MatFiles/L11-5gHFlashDoppler');
