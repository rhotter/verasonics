...
%   for its use
%
% File name: SetUpL11_5gH_128RyLnsMultiFocal.m - Imaging with dynamic focus transmits
%
% Description:
...
Resource.RcvBuffer.rowsPerFrame = 196608; % this should be larger than 128*Receive.endDepth*2(round trip)*2(smpls/wave) for max depth
Resource.RcvBuffer.colsPerFrame = Resource.Parameters.numRcvChannels;
Resource.RcvBuffer.numFrames = 10;
Resource.InterBuffer(1).numFrames = 1;  % one intermediate buffer needed.
Resource.ImageBuffer(1).numFrames = 10;
Resource.DisplayWindow.Title = 'L11-5gH_128RyLnsMultiFocal';
...
% Specify nr TX structure arrays for each focal zone. Transmit on element n in the array for event n.
...
% - We need nr Receives for each focus and for each frame.
...
save('MatFiles/L11-5gH_128RyLnsMultiFocal');

%% **** Callback functions used by UI ****
