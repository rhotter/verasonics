...
%   for its use
%
% File name: SetUpL11_5gHFlashSL.m - Plane wave transmit with steered linear array
%
% Description:
%   Sequence programming file for L11-5gH Linear array, using a plane wave
%   transmit with steered linear array and single receive acquisition. All
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashSL';
