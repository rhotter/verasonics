...
%   for its use
%
% File name: SetUpL11_5gHFlashDopplerLF.m - Plane wave doppler imaging with
...
% set dtheta2D to range over +/- 18 degrees.
if (na > 1)
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashDopplerLF';
...
save('MatFiles/L11-5gHFlashDopplerLF');
