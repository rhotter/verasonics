...
%   for its use
%
% File name: SetUpL11_5gH_128RyLns.m - Example of linear array imaging with
%                                     focused transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5gH_128RyLns';
...
% Specify 128 TX structure arrays. Transmit centered on element n in the array for event n.
...
UI(4).Control = VsSliderControl('LocationCode','UserB3',...
    'Label',['F number (',AxesUnit,')'],...
    'SliderMinMaxVal',[1,20,round(P.txFocus/(P.numTx*Trans.spacing))],'SliderStep',[0.05,0.1],...
    'ValueFormat','%2.0f',...
...
save('MatFiles/L11-5gH_128RyLns');
