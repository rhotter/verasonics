...
%   for its use
%
% File name RunSetUpL11_5gHFlashHFR_reconAll.m: "High Frame Rate" post-acquisition processing script (script 2 of 2)
%
% Description:
% To support higher acquisition frame rates with reduced DMA overhead, the first script (SetupL11_4vFlashHFR_acquire) acquires
...
%
% To illustrate the HFR effect in simulation, the 'movePoints' function is invoked (in SetupL11_4vFlashHFR_acquire)
...
simulateMode = 2; % use mode=2 for post processing data collected by 'SetupL11_4vFlashHFR' and stored in 'RFdataHFR.mat'.
...
filename = 'L11-5gHFlashHFR_reconAll';
