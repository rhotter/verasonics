...
%   for its use
%
% File name: SetUpL11_5gHFlashAngles.m - Example of plane wave imaing with
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashAngles';
...
SeqControl(3).argument = 20000 - (na-1)*160;  % 20 msec - 160 usec per synthetic aperture acquisition
...
save('MatFiles/L11-5gHFlashAngles');
