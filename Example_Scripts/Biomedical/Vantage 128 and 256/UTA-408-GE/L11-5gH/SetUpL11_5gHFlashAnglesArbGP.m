...
%   for its use
%
% File name: SetUpL11_5gHFlashAnglesArbGP.m - Plane wave imaging with arbitrary
...
%   L11-5gH scanhead, and applied to all element channels.
%   The resulting encoding was tested on a different L11-5gH scanhead and found
%   to retain its effectiveness.  Results on other L11-5gH scanheads may vary.
%
% Last update:
...
Resource.DisplayWindow(1).Title = ['L11-5gHFlashAnglesArbGP:',WFName];
...
save('MatFiles/L11-5gHFlashAnglesArbGP');
