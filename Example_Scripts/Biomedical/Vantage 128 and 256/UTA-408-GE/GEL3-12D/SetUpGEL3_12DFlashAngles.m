...
%   for its use
%
% File name: SetUpGEL3_12DFlashAngles.m - Example of 3-1 synthetic aperture plane
...
Trans = computeTrans(Trans);  % GEL3-12D transducer is 'known' transducer so we can use computeTrans.
...
Resource.DisplayWindow(1).Title = 'GEL3-12DFlashAngles';
...
save('MatFiles/GEL3-12DFlashAngles');
return
