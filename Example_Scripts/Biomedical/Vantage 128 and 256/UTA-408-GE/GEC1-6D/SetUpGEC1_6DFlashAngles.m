...
%   for its use
%
% File name: SetUpGEC1_6DFlashAngles.m - Example of curved array flash imaging
%                                      with steering angle transmits
% Description:
%   Sequence programming file for GEC1-6D curved array, using flash transmits
...
Trans.name = 'custom'; % avoid id check
...
Resource.DisplayWindow(1).Title = 'GEC1-6DFlashAngles';
...
save('MatFiles/GEC1-6DFlashAngles');
return
