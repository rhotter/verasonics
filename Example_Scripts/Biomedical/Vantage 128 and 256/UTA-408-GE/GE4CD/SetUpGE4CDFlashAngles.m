...
%   for its use
%
% File name: SetUpGE4CDFlashAngles.m - Example of curved array flash imaging
%                                      with steering angle transmits
% Description:
%   Sequence programming file for GE4CD curved array, using flash transmits
...
Resource.DisplayWindow(1).Title = 'GE4CDFlashAngles';
...
save('MatFiles/GE4CDFlashAngles');
return
