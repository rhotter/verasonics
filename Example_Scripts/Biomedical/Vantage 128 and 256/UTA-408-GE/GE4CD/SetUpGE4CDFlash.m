...
%   for its use
%
% File name: SetUpGE4CDFlash.m - Example of curved array imaging with flash
%                                transmit
% Description:
%   Sequence programming file for GE4CD curved array, using a flash transmit
...
Resource.DisplayWindow(1).Title = 'GE4CDFlash';
