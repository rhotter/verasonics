...
%   for its use
%
% File name: SetUpGE9LDFlash.m - Example of curved array imaging with flash
%                                transmit
% Description:
%   Sequence programming file for GE9LD curved array, using a flash transmit
...
Resource.DisplayWindow(1).Title = 'GE9LDFlash';
...
Control = evalin('base','Control');
Control.Command = 'update&Run';
Control.Parameters = {'PData','InterBuffer','ImageBuffer','Receive','TGC','Recon','DisplayWindow','TGC'};
assignin('base','Control', Control);
