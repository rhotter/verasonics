...
%   for its use
%
% File name: SetUpGE9LDFlashDoppler.m - Example of plane wave doppler imaging
%
% Description:
%   Sequence programming file for GE9LD Linear array, using plane wave
...
%
% Last update:
% 11/17/2015 - modified for SW 3.0
...
PData(2).Size(2) = ceil((192*Trans.spacing)/PData(2).PDelta(1));  % flow window columns
...
Resource.DisplayWindow(1).Title = 'GE9LDFlashDoppler';
...
% - Doppler TGC
TGC(2).CntrlPts = [0,220,508,662,662,662,662,662];
...
save('MatFiles/GE9LDFlashDoppler');
return
