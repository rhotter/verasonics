...
%   for its use
%
% File name: SetUpGEIC5_9DFlash.m - Example of curved array imaging with flash
%                                transmit
% Description:
%   Sequence programming file for GEIC5-9D curved array, using a flash transmit
...
Resource.DisplayWindow(1).Title = 'GEIC5-9DFlash';
