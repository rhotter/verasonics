...
%   for its use
%
% File name: SetUpC5_2gH_128RyLns.m - Example of curved array imaging with
%                                    focus transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2gH_128RyLns';
