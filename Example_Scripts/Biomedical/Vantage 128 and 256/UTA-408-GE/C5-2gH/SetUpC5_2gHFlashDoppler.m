...
%   for its use
%
% File name: SetUpC5_2gHFlashDoppler.m - Example of curved array doppler
...
% 10/01/2010  - modified for C5-2gH
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashDoppler';
...
save('MatFiles/C5-2gHFlashDoppler');
...
filename = 'C5-2gHFlashDoppler';  VSX;
