...
%   for its use
%
% File name: SetUpC5_2gHFlashAngles.m - Example of curved array flash imaging
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashAngles';
...
save('MatFiles/C5-2gHFlashAngles');
...
% filename = 'C5-2gHFlashAngles';  VSX;
