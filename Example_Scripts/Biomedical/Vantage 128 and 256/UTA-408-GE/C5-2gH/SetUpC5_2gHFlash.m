...
%   for its use
%
% File name: SetUpC5_2gHFlash.m - Example of curved array imaging with flash
%                                transmit
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlash';
