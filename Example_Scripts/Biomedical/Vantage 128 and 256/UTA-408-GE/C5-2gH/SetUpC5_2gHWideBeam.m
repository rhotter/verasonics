...
%   for its use.
%
% File name: SetUpC5_2gHWideBeam.m - Example of curved array imaging with
%                                   wide beam transmits
% Description:
...
%
%   The PData regions are generated to provide an overlap of 7 regions at every pixel.
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeam';
