...
%   for its use
%
% File name: SetUpC5_2gHFlashDopplerLF.m - Example of curved array flash
%            Doppler imaging using "EnsembleLength" statement
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashDopplerLF';
...
save('MatFiles/C5-2gHFlashDopplerLF');
...
% filename = 'C5-2gHFlashDopplerLF';  VSX;
