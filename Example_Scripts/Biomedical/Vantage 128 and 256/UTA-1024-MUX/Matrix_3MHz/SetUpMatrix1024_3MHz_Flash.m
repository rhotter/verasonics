%  SetUpMatrix1024_3MHz_Flash This script demonstrates use of dynamic mux
%  programming using the 1024 element 3 MHz 2D matrix array probe from 
%  Vermon with the UTA 1024-MUX adapter on a Vantage 256 system.  Apod
%  arrays are set to the full 1024 element length, and apertures are
%  synthesized by the "computeMuxAperture" function to match the
%  user-defined Apod for each TX and Receive.
%
%  The 1024-element array is divided into four 256-element apertures for use
%  with the 1024-MUX adapter module.  Full 1024 element acquisition is
%  accomplished by combining the results of 16 acquisition events, pairing
%  each of the four transmit apertures with each of the four receive
%  apertures.
%
