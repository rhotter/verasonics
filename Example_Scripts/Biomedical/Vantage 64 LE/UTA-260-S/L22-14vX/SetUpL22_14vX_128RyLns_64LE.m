...
%   for its use
%
% File name: SetUpL22_14vX128RyLns_64LE.m.m - Example of scanline imaging with focused
...
Resource.DisplayWindow.Title = 'L22-14vX128RyLns_64LE';
...
save('MatFiles/L22-14vX_128RyLns_64LE');
% filename = ('L22-14vX_128RyLnsLE'); % VSX   % permits immediately running VSX without specifying the matfile name
return
