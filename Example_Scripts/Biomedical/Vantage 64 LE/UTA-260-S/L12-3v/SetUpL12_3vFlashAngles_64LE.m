...
%   for its use
%
% File name: SetUpL12_3vFlashAngles_64LE.m - Example of 3-1 synthetic aperture plane
...
Resource.RcvBuffer(1).rowsPerFrame = 4096*3*na; % this size allows for 3 acqs per angle, maximum range
...
Resource.DisplayWindow(1).Title = 'L12-3vFlashAngles_64LE';
...
ReconInfo(3*na).mode = 'accumIQ_replaceIntensity';
...
save('MatFiles/L12-3vFlashAngles_64LE');
return
