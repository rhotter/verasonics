...
%   for its use
%
% File name: SetUpL12_3vFlash_64LE.m - Example of 3-1 synthetic aperture plane
%                                 wave imaging with signle transmit
% Description:
...
%   system. 128 transmit channels and 64 receive channels are active and
%   positioned as follows (each char represents 4 elements) for each of the
%   3 synthetic apertures.
%
%   Element Nos.                                1              1
%                               6       9       2              9
%               1               5       7       9              2
...
Resource.DisplayWindow(1).Title = 'L12-3vFlash_64LE';
...
TX(2).aperture = 33; % Use the tx aperture that starts at element 33.
TX(3).aperture = 65; % Use the tx aperture that starts at element 65.
...
ReconInfo(3).mode = 'accumIQ_replaceIntensity';
ReconInfo(3).txnum = 3;
...
save('MatFiles/L12-3vFlash_64LE');
return
