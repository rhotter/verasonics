...
%   for its use.
%
% File name: SetUpP4_2vWideBeamHI_64LE.m - Example of phased array pulse inversion
...
%   elements 0-63 connected to inputs 1-64. We therefore need a
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeamHI_64LE';
...
save('MatFiles/P4-2vWideBeamHI_64LE');
return
