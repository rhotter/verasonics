...
%   for its use
%
% File name: SetUpP4_2v_128RyLns_64LE.m - Example of phased array imaging with
%                                    focus transmits
% Description:
...
%   element 0-63 connected to inputs 33-96. We therefore need a Trans.Connector array to
...
Resource.DisplayWindow(1).Title = 'P4-2v_128RyLns_64LE';
...
save('MatFiles/P4-2v_128RyLns_64LE');
return
