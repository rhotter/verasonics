...
%   for its use.
%
% File name: SetUpP4_2vFlashDoppler_64LE.m - Example of phased array flash
%                                       Doppler imaging
% Description:
...
%   the scanhead connector with elements 0-63 connected to inputs 1-64. We
...
Resource.DisplayWindow(1).Title = 'P4-2vFlashDoppler_64LE';
...
save('MatFiles/P4-2vFlashDoppler_64LE');
return
