...
%   for its use.
%
% File name: SetUpP4_2vWideBeam_64LE.m - Example of phased array imaging with
%                                   wide beam transmits
% Description:
...
%   asynchronous with respect to acquisition. Note: The P4-2v is a 64 element
%   probe that is wired to the scanhead connector with elements 0-63
%   connected to inputs 1-64. We therefore need a Trans.Connector array
%   to specify the connector channels used, which will be defined
%   by the computeTrans function.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'P4-2vWideBeam_64LE';
...
save('MatFiles/P4-2vWideBeam_64LE');
return
