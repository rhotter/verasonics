...
%   for its use.
%
% File name: SetUpP4_2vFlash_64LE.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
...
%   the scanhead connector with element 0-63 connected to inputs 33-96.
...
Resource.DisplayWindow(1).Title = 'P4-2vFlash_64LE';
