...
%   for its use
%
% File name: SetUpL11_5vFlashAnglesSC_64LE.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAnglesSC_64LE';
...
save('MatFiles/L11-5vFlashAnglesSC_64LE');
return
