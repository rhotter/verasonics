...
%   for its use
%
% File name: RunSetUpL11_5vFlashHFR_acquire_64LE.m - "High Frame Rate" acquisition for ultrafast imaging (script 1 of 2).
%
% Description:
...
filename = 'L11-5vFlashHFR_acq_64LE'; % used to launch VSX automatically
...
RunSetUpL11_5vFlashHFR_reconAll_64LE    % be sure that simulateMode=2 in that script!!!
