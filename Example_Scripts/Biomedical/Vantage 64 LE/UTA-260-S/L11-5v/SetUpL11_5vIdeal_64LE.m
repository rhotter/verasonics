...
%   for its use.
%
% File name: SetUpL11_5vIdeal_64LE.m - Example of imaging using ideal synthetic
%                                 aperture reconstruction
%
% Description:
%   Sequence programming file for L11-5v Linear array, using ideal synthetic
...
Resource.RcvBuffer(1).rowsPerFrame = 1280*m*2; % 1280 samples ok for up to 240 wl range at 2 samples per wavelength.
...
Resource.DisplayWindow(1).Title = 'L11-5vIdeal_64LE';
...
save('MatFiles/L11-5vIdeal_64LE');
return
