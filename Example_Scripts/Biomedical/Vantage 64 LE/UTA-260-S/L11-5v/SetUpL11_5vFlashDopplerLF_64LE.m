...
%   for its use
%
% File name: SetUpL11_5vFlashDopplerLF_64LE.m - Plane wave doppler imaging with
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashDopplerLF_64LE';
...
save('MatFiles/L11-5vFlashDopplerLF_64LE');
return
