...
%   for its use
%
% File name: SetUpL11_5vWideBeamHI_64LE.m - Pulse inversion imaging with widebeam transmit
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5vWideBeamHI_64LE';
...
save('MatFiles/L11-5vWideBeamHI_64LE');
return
