...
%   for its use
%
% File name: SetUpL11_5vFlashSL_64LE.m - Plane wave transmit with steered linear array
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashSL_64LE';
...
save('MatFiles/L11-5vFlashSL_64LE');
return
