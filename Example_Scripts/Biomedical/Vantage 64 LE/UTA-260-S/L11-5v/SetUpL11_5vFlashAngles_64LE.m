...
%   for its use
%
% File name: SetUpL11_5vFlashAngles_64LE.m - Example of plane wave imaing with
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAngles_64LE';
...
save('MatFiles/L11-5vFlashAngles_64LE');
return
