...
%   for its use
%
% File name RunSetUpL11_5vFlashHFR_reconAll_64LE.m: "High Frame Rate" post-acquisition processing script (script 2 of 2)
%
% Description:
...
filename = 'L11-5vFlashHFR_reconAll_64LE';
