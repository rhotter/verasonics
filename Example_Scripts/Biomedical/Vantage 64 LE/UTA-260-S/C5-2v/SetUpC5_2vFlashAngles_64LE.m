...
%   for its use
%
% File name: SetUpC5_2vFlashAngles_64LE.m - Example of curved array flash imaging
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashAngles_64LE';
...
save('MatFiles/C5-2vFlashAngles_64LE');
return
