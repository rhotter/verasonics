...
%   for its use.
%
% File name: SetUpC5_2vWideBeam_64LE.m - Example of curved array imaging with
%                                   wide beam transmits
% Description:
%   Sequence programming file for C5-2v curved array using m wide beam
%   transmits and receive acquisitions. Of the 128 transmit channels, only
%   81 are used, with 40 transmitters on each side of the center element
%   (where possible). On the 64 receive channels, the central 64 elements
%   are active for each receive. The receive acquisitions use 100% bandwidth
%   to improve DMA transfers.Processing is asynchronous with respect to
%   acquisition.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeam_64LE';
...
UI(3).Control = {'UserB4','Style','VsSlider','Label',['TX Focus (',AxesUnit,')'],...
                 'SliderMinMaxVal',[100,600,P.txFocus]*wls2mm,'SliderStep',[0.1,0.2],'ValueFormat','%3.0f'};
...
save('MatFiles/C5-2vWideBeam_64LE');
return
