...
%   for its use
%
% File name: SetUpC5_2vFlashDopplerLF_64LE.m - Example of curved array flash doppler
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashDopplerLF_64LE';
...
save('MatFiles/C5-2vFlashDopplerLF_64LE');
return
