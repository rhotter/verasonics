...
%   for its use
%
% File name: SetUpC5_2v_128RyLns_64LE.m - Example of curved array imaging with
%                                    focus transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2v_128RyLns_64LE';
...
save('MatFiles/C5-2v_128RyLns_64LE');
return
