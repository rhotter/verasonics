...
%   for its use
%
% File name: SetUpC5_2vFlashDoppler_64LE.m - Example of curved array doppler
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashDoppler_64LE';
...
save('MatFiles/C5-2vFlashDoppler_64LE');
return
