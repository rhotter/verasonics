...
%   for its use
%
% File name: SetUpC5_2vFlash_64LE.m - Example of curved array imaging with flash
%                                transmit
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2vFlash_64LE';
