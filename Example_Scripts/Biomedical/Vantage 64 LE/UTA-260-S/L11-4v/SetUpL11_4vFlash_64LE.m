...
%   for its use
%
% File name: SetUpL11_4vFlash_64LE.m - Example of imaging with single plane
%                                  wave transmit
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-4vFlash_64LE';
...
SeqControl(3).argument = 9800;  % 9.8 msec
...
save('MatFiles/L11-4vFlash_64LE');
return
