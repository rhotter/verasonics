...
%   for its use
%
% File name: SetUpL11_4v_128RyLnsMultiFocal_64LE.m - Imaging with dynamic focus transmits
%
% Description:
...
Resource.RcvBuffer.rowsPerFrame = nr*2048; % this should be larger than 128*Receive.endDepth*2(round trip)*2(smpls/wave) for max depth
Resource.RcvBuffer.colsPerFrame = Resource.Parameters.numTransmit;
Resource.RcvBuffer.numFrames = 10;
Resource.InterBuffer(1).numFrames = 1;  % one intermediate buffer needed.
Resource.ImageBuffer(1).numFrames = 10;
Resource.DisplayWindow.Title = 'L11-4v_128RyLnsMultiFocal_64LE';
...
% - We need 2*fz*nr Receives for every frame.
...
TGC.CntrlPts = [0,137,149,287,333,644,827,1023];
...
SeqControl(1).argument = 200;  % 200 usec between ray lines; should be > 2*Receive.endDepth*T(period)
...
save('MatFiles/L11-4v_128RyLnsMultiFocal_64LE');
