...
%   for its use
%
% File name: SetUpL11_4vWideBeamHI_64LE.m - Pulse inversion imaging with widebeam transmit
%
% Description:
%   Sequence programming file for L11-4v Linear array, using widebeam pulse
...
Resource.DisplayWindow(1).Title = 'L11-4vWideBeamHI_64LE';
...
% - We need 4*numRay Receives for pulse inversion.
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:2:2*P.numRays
        ...
        else Receive(4*P.numRays*(i-1)+j).Apod(65:128) = 1.0;
    ...
    for j = 1:2:2*P.numRays
        ...
        else Receive(4*P.numRays*(i-1)+j+k).Apod(65:128) = 1.0;
...
save('MatFiles/L11-4vWideBeamHI_64LE');
return
