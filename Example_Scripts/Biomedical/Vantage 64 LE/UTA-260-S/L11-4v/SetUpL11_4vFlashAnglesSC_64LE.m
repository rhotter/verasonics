...
%   for its use
%
% File name: SetUpL11_4vFlashAnglesSC_64LE.m - Plane wave transmits with steering
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashAnglesSC_64LE';
...
% - We need 2*na Receives for every frame, for na angles and 2-1 synthetic
% aperture
...
% We need 2*na ReconInfo structures for na steering angles and 2-1 synthetic aperture.
...
save('MatFiles/L11-4vFlashAnglesSC_64LE');
return
