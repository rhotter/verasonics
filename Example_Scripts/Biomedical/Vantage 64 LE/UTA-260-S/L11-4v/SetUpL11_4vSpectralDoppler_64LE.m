...
%   for its use
%
% File name: SetUpL11_4vSpectralDoppler_64LE.m - Spectral doppler with plane wave transmit.
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-4vSpectralDoppler_64LE';
...
save('MatFiles/L11-4vSpectralDoppler_64LE');
