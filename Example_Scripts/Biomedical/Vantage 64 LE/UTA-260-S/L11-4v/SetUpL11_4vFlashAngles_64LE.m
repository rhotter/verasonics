...
%   for its use
%
% File name: SetUpL11_4vFlashAngles_64LE.m - Example of plane wave imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashAngles_64LE';
...
% - We need 2*na Receives for each frame, for na angles and 2-1 synthetic aperture.
...
% We need 2*na ReconInfo structures for na steering angles and 2-1
% synthetic aperture
...
save('MatFiles/L11-4vFlashAngles_64LE');
return
