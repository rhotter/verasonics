...
%   for its use
%
% File name: SetUpL11_4vFlashDoppler_64LE.m - Example of plane wave doppler imaging
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashDoppler_64LE';
...
save('MatFiles/L11-4vFlashDoppler_64LE');
return
