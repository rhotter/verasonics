...
%   for its use
%
% File name: SetUpL11_4v_128RyLns_64LE.m - Example of linear array imaging with
%                                     focused transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-4v_128RyLns_64LE';
...
% - We need 2*128 Receives for every frame, due to 2-1 synthetic aperture
...
save('MatFiles/L11-4v_128RyLns_64LE');
