...
%   for its use
%
% File name: SetUpL11_4vFlashDopplerLF_64LE.m - Plane wave doppler imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashDopplerLF_64LE';
...
save('MatFiles/L11-4vFlashDopplerLF_64LE');
return
