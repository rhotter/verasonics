...
%   for its use
%
% File name: SetUpC5_gHFlashDoppler_64LE.m - Example of curved array doppler
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashDoppler_64LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = (2*na+1):(2*na+ne);
        ...
        Receive(j+k).endDepth = maxAcqLengthDop;
...
Recon(1).RINums(1,1:2*na) = 1:2*na;  % 2*na ReconInfos needed for na angles and synthetic aperture
k = 2*na + 1;
...
save('MatFiles/C5-2gHFlashDoppler_64LE');
