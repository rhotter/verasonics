...
%   for its use
%
% File name: SetUpC5_2gHFlashAngles_64LE.m - Example of curved array flash imaging
%                                      with steering angle transmits
% Description:
%   Sequence programming file for C5-2gh curved array, using flash transmits
%   with multiple steering angles and 2-1 synthetic aperture acquisation.
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashAngles_64LE';
...
TGC.CntrlPts = [0,256,399,519,603,715,798,859];
...
% We need 2*na ReconInfo structures for na steering angles and synthetic aperture.
...
SeqControl(3).argument = 20000 - (2*na-1)*200;  % 20 msec
...
save('MatFiles/C5-2gHFlashAngles_64LE');
