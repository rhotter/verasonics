...
%   for its use.
%
% File name: SetUpC5_2gHWideBeamHI_64LE.m - Example of curved array imaging with
%                                   wide beam transmits and harmonic imaging.
% Description:
%   Sequence programming file for C5-2gH curved array using m wide beam pulse
...
%   10/03/2021 Modified for C5-2gH
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeamHI_64LE';
...
UI(3).Control = VsSliderControl('LocationCode','UserB4',...
    ...
    'SliderMinMaxVal',[100,800,P.txFocus]*wls2mm,...
    'SliderStep',[0.1,0.2],'ValueFormat','%3.0f',...;
...
save('MatFiles/C5-2gHWideBeamHI_64LE');
