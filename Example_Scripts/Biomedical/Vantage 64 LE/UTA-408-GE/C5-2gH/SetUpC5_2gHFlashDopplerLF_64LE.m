...
%   for its use
%
% File name: SetUpC5_2gHFlashDopplerLF_64LE.m - Example of curved array flash doppler
%                                        imaging using "EnsembleLength" statement
% Description:
%   Sequence programming file for C5-2gH curved array, using flash transmits
...
%   - all 128 transmit and receive channels are active for each 2-1 synthetic
%     aperture (for 2D) and doppler acquisitions.
%   - processing is asynchronous with respect to acquisition.
%
% Last update:
% 12/14/2015 - modified for SW 3.0
% 10/09/2021 - modified for C5-2gH
...
Resource.DisplayWindow(1).Title = 'C5-2gHFlashDopplerLF_64LE';
...
% - We need 2*na Receives for a 2D frame and ne Receives for a Doppler frame.
...
Recon(1).RINums(1,1:2*na) = (1:2*na);  % 2*na ReconInfos needed for na angles
k = 2*na + 1;
...
% - For 2D, we need 2*na ReconInfo structures for na steering angles and synthetic aperture.
...
save('MatFiles/C5-2gHFlashDopplerLF_64LE');
