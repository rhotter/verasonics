...
%   for its use.
%
% File name: SetUpC5_2gHWideBeam_64LE.m - Example of curved array imaging with
%                                   wide beam transmits
% Description:
%   Sequence programming file for C5-2gH curved array using m wide beam
...
Resource.DisplayWindow(1).Title = 'C5-2gHWideBeam_64LE';
...
save('MatFiles/C5-2gHWideBeam_64LE');
