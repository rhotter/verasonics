...
%   for its use
%
% File name: SetUpL11_5gHFlashDopplerLF_64LE.m - Plane wave doppler imaging with
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashDopplerLF_64LE';
...
save('MatFiles/L11-5gHFlashDopplerLF_64LE');
