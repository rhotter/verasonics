...
%   for its use
%
% File name: SetUpL11_5gHFlash_64LE.m - Example of imaging with single plane
%                                  wave transmit
% Description:
%   Sequence programming file for L11-5gH Linear array, using a plane wave
%   transmit with 2-1 synthetic aperture (two acquisitions per line to
%   acquire data from all 128 receive elements). All 128 transmit and 64
%   receive channels are active for each synthetic aperture acquisition.
%   External processing is used asynchronous with respect to acquisition.
%
% Last update:
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlash_64LE';
...
SeqControl(2).command = 'timeToNextAcq';  % time between 2-1 synthetic aperture acquisation
SeqControl(2).argument = 200;
SeqControl(3).command = 'timeToNextAcq';  % time between frames
SeqControl(3).argument = 9800;  % 10 msec
...
save('MatFiles/L11-5gHFlash_64LE');
