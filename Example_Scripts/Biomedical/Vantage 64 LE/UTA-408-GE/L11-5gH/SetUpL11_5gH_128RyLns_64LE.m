...
%   for its use
%
% File name: SetUpL11_5gH_128RyLns_64LE.m - Example of linear array imaging with
%                                     focused transmits
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5gH_128RyLns_64LE';
...
save('MatFiles/L11-5gH_128RyLns_64LE');


% **** Callback funcitons to be used by UI Controls ****
