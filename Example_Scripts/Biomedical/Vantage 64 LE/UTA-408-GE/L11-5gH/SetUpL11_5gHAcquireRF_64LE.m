...
%   for its use
%
% File name: SetUpL11_5gHAcquireRF_64LE.m - Example of RF data acquisition
%
% Description:
...
%  10/04/2021 - modified for L11-5gH
...
save('MatFiles/L11-5gHAcquireRF_64LE');
...
function myProcFunction(RData)
    ...
    if channel < 65
        ...
        plot(myHandle,RData(Receive(2).startSample:Receive(2).endSample,channel)); 
    end
    drawnow limitrate
end
