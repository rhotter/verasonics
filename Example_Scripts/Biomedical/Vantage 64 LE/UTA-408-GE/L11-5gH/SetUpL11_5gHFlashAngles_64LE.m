...
%   for its use
%
% File name: SetUpL11_5gHFlashAngles_64LE.m - Example of plane wave imaing with
...
%
% Last update:
% 09/20/21 - modified for new transducer L11-5gH
...
Resource.DisplayWindow(1).Title = 'L11-5gHFlashAngles_64LE';
...
% We need 2*na ReconInfo structures for na steering angles and 2-1 synthetic aperture aquisitions.
...
save('MatFiles/L11-5gHFlashAngles_64LE');
