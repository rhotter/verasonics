...
%   for its use
%
% File name RunSetUpL11_5gHFlashHFR_reconAll_64LE.m: "High Frame Rate" post-acquisition processing script (script 2 of 2)
%
% Description:
...
%
% 09/20/21 creat for new transducer L11-5gH
...
if simulateMode ==2
    load ('RFdataHFR_64LE')  % this file includes RcvData and the numAcqs and numFrames parameters for properly setting Resources
else
...
filename = 'L11-5gHFlashHFR_reconAll_64LE';
