...
%   for its use.
%
% File name: SetUpP4_2gHFlashAngles_64LE.m - Example of phased array flash imaging
...
%   the scanhead connector with element 1-96 connected to inputs 1-96. We
%   therefore need a Trans.Connector array to specify the connector
...
Resource.DisplayWindow(1).Title = 'P4-2vFlashAngles_64LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:na
        Receive(na*(i-1)+j).Apod(Trans.numelements/2-31:Trans.numelements/2+32) = 1;
...
save('MatFiles/P4-2gHFlashAngles_64LE');
