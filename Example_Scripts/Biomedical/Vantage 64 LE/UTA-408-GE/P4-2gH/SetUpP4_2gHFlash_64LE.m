...
%   for its use.
%
% File name: SetUpP4_2gHFlash_64LE.m - Example of phased array imaging with
%                                flash transmit scan
% Description:
%   Sequence programming file for P4-2gH phased array in virtual apex format,
%   using a flash tranmist and receive acquisitions. 128 transmit and 64
...
%   the scanhead connector with element 1-96 connected to inputs 1-96.
...
Resource.DisplayWindow(1).Title = 'P4-2gHFlash_64LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    Receive(i).Apod(Trans.numelements/2-31:Trans.numelements/2+32) = 1;
...
save('MatFiles/P4-2gHFlash_64LE');
