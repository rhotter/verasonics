...
%   for its use
%
% File name: SetUpL22_14vFlashAngles_64.m - Example of plane wave imaging with multiple steered angle transmits
%
% Description:
...
Resource.RcvBuffer(1).rowsPerFrame = na*6144*3; % this size allows for maximum range
...
save('MatFiles/L22-14vFlashAngles_64');
return
