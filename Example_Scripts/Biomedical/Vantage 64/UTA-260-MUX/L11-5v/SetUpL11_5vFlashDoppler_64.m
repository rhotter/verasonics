...
%   for its use
%
% File name: SetUpL11_5vFlashDoppler_64.m -  Example of 3-1 synthetic aperture doppler
%                                     imaging woth flash transmits
% Description:
%   Sequence programming file for L11-5v Linear array, using 3-1
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashDoppler_64';
...
save('MatFiles/L11-5vFlashDoppler_64');
return
