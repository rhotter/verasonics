...
%   for its use
%
% File name: SetUpL11_5v_128RyLns_64.m - Example of linear array imaging with
%                         focused transmits on Vantage 64 UTA Mux system
% Description:
...
Resource.DisplayWindow(1).Title = 'L11-5v_128RyLns_64';
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'Delay', zeros(1,Resource.Parameters.numTransmit)), 1, 128);
...
save('MatFiles/L11-5v_128RyLns_64');
