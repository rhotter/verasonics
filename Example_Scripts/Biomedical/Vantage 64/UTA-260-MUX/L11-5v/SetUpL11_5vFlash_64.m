...
%   for its use
%
% File name: SetUpL11_5vFlash_64.m - Example of 2-1 synthetic aperture plane
%                                      wave imaging with 260-MUX UTA.
% Description:
%   Sequence programming file for L11-5v Linear array, using a full aperture transmit
...
Resource.DisplayWindow(1).Title = 'L11-5vFlash_64';
