...
%   for its use
%
% File name: SetUpL11_5vFlashAngles_64.m - Example of plane wave imaging with
...
%
% Last update:
% 7/12/2017 - Modified for Vantage 64 from Vantage 128 version
% 8/22/2018 - script improvement
...
Resource.RcvBuffer(1).rowsPerFrame = na*4096*3; % this size allows for maximum range
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashAngles_64';
...
% We need 3*na ReconInfo structures for na steering angles and synthetic
% aperture
...
SeqControl(3).argument = 20000 - (3*na-1)*TTNA;  % 20 msec
...
save('MatFiles/L11-5vFlashAngles_64');
return
