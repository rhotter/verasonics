...
%   for its use
%
% File name: SetUpL22_14v_LF_128RyLns_64.m.m - Example of scanline imaging with focused
%                                          transmits at a single focal depth.
%
% Description:
%   Sequence programming file for L22-14v LF Linear array, using 128 ray lines
...
%   the L22-14v LF(18MHz center frequency, 67% bandwidth). Processing is
%   asynchronous with respect to acquisition.
%
% Last update:
% 03/30/2018 - Implemented with dynamic MUX programming for V64.
...
P.numTx = 31;  % number of transmit elements in TX aperture (where possible).
...
Resource.RcvBuffer.rowsPerFrame = 5376*128;   % this size allows for maximum range
...
Resource.DisplayWindow.Title = 'L22-14v LF 128RyLns_64';
...
save('MatFiles/L22-14v_LF128RyLns_64');
% filename = ('L22-14v_LF_128RyLns_64'); % VSX    % permits immediately running VSX without specifying the matfile name
return
