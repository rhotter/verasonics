...
%   for its use
%
% File name: SetUpL22_14v_LF_FlashAngles_64.m - Example of plane wave imaging with multiple steered angle transmits
%
% Description:
...
%   support the 12 MHz bandwidth of the L22-14v LF (18MHz center frequency,
...
Resource.DisplayWindow(1).Title = 'L22-14v LF FlashAngles';
...
save('MatFiles/L22-14v_LF_FlashAngles_64');
return
