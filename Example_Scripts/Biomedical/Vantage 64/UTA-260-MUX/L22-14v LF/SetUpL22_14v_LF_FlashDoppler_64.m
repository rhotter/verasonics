...
%   for its use
%
% File name: SetUpL22_14v_LF_FLashDoppler_64.m - Example of plane wave Doppler imaging, using FlashAngles for B-mode image
%
% Description:
%   Sequence programming file for L22-14v LF Linear array, using plane wave
...
%     L22-14v LF (18 MHz center frequency, ~67% bandwidth).
%
%   For Imaging:
%   Sequence programming file for L22-4v LF Linear array, using 3-1
...
Resource.DisplayWindow(1).Title = 'L22-14v LF Flash Doppler, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14v_LF_FlashDoppler_64');
return
