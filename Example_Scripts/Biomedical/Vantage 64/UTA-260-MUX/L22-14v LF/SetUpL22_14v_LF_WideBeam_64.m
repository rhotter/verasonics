...
%   for its use
%
% File name: SetUpL22_14v_LF_WideBeam_64.m - Example of imaging with partially focused "wide beam" transmits
%
% Description:
%   Sequence programming file for L22-14v LF Linear array, using numrays widebeam
...
Trans = computeTrans(Trans);  % L22-14v LF transducer is 'known' transducer so we can use computeTrans.
...
Resource.DisplayWindow(1).Title = 'L22-14v LF Wide Beam, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14v_LF_WideBeam_64');
