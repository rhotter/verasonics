...
%   for its use
%
% File name: SetUpC5_2vFlash_64.m - Example of 2-1 synthetic aperture curved array imaging with flash
%                                transmit
% Description:
...
Resource.DisplayWindow(1).Title = 'C5-2vFlash_64';
