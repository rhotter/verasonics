...
%   for its use.
%
% File name SetUpC5_2vWideBeam_64.m: Example of curved array imaging with
%   wide beam transmits
% Generate .mat Sequence Object file for C5_2v Linear array wide beam
% transmit. The transmit aperture size can be set by the variable - numTx.
% The transmit aperture is translated across the array with the number of
% rays set by the variable - numRays. The receive aperture always covers
% the full 64 element aperture.
%
%
...
% 06/10/2019 Modified for 4.0.1 software.
...
Resource.DisplayWindow(1).Title = 'C5-2vWideBeam_64';
...
TGC.CntrlPts = [60,387,579,705,791,868,906,919];
...
save('MatFiles/C5-2vWideBeam_64');
