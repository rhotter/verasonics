...
%   for its use
%
% File name: SetUpL22_14vXFLashDoppler_64.m - Example of plane wave Doppler imaging, using FlashAngles for B-mode image
%
% Description:
...
%
%   For Imaging:
%   Sequence programming file for L22-4vX Linear array, using 3-1
...
%   IQ data from the 3 apertures and multiple angles and computes intensity values to produce
...
%
%   Last update:
%   08/22/2018 - script improvement
%   04/12/2021 - updated for use with 4.5 releases
...
Resource.DisplayWindow(1).Title = 'L22-14vX Flash Doppler, 4X sampling at 62.5 MHz';
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'Delay', zeros(1,Resource.System.transmitChannels)), 1, (3*na)+1); % na TXs for 2D + 1 for Doppler
...
TX((3*na)+1).Apod = ones(1,Resource.System.transmitChannels);
TX((3*na)+1).aperture = 33;
...
Receive = repmat(struct('Apod', zeros(1,Resource.System.receiveChannels), ...
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:3:3*na  % acquisitions for 2D
...
save('MatFiles/L22-14vXFlashDoppler_64');
