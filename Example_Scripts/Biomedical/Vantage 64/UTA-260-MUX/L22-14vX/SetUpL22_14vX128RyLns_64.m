...
%   for its use
%
% File name: SetUpL22_14vX128RyLns_64.m.m - Example of scanline imaging with focused
...
%   the L22-14vX (18MHz center frequency, 67% bandwidth). 
...
%    
%   Last update:
%   03/22/2021 - updated for L22-14vX to use with 4.5 release
...
Resource.RcvBuffer.rowsPerFrame = 6144*128;   % this size allows for maximum range
...
Resource.DisplayWindow.Title = 'L22-14vX128RyLns_64';
...
save('MatFiles/L22-14vX_128RyLns_64');
% filename = ('L22-14vX_128RyLns_64'); % VSX    % permits immediately running VSX without specifying the matfile name
