...
%   for its use
%
% File name: SetUpL22_14XvFlash_64.m - Example of 2-1 synthetic aperture plane
%                                       wave imaging with 260-MUX UTA.
%
% Description:
%   Sequence programming file for L22-14vX Linear array,using a full aperture transmit
...
Resource.RcvBuffer(1).rowsPerFrame = 2*6144; % this size allows for maximum range
...
Resource.DisplayWindow(1).Title = 'L22-14vX Flash, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14vXFlash_64');
