...
%   for its use
%
% File name: SetUpL22_14vX_LF_128RyLns_64.m.m - Example of scanline imaging with focused
%                                          transmits at a single focal depth.
%
% Description:
%   Sequence programming file for L22-14vX LF Linear array, using 128 ray lines
...
%
% Last update:
%   03/21/21 - updated for 4.5 release
...
Resource.DisplayWindow.Title = 'L22-14vX LF 128RyLns_64';
...
save('MatFiles/L22-14vX_LF_128RyLns_64');
% filename = ('L22-14vX_LF_128RyLns_64'); % VSX    % permits immediately running VSX without specifying the matfile name
