...
%   for its use
%
% File name: SetUpL22_14vX_LF_FlashAngles_64.m - Example of plane wave imaging with multiple steered angle transmits
%
% Description:
%   Sequence programming file for L22-14vX LF Linear array, using plane wave
%   transmits with multiple steering angles and 3-1 synthetic aperture
...
%   for each of the 3 synthetic apertures. This script uses 4X sampling
...
%   support the 12 MHz bandwidth of the L22-14vX LF (18MHz center frequency,
...
%
% Last update:
%   03/22/2021 - updated for L22-14vX LF to use with 4.5 release
...
Resource.RcvBuffer(1).rowsPerFrame = 3*na*6144;
...
Resource.DisplayWindow(1).Title = 'L22-14vX LF FlashAngles';
...
save('MatFiles/L22-14vX_LF_FlashAngles_64');
