...
%
% Last update:
% 12/03/2015 - modified for SW 3.0
% 24/08/2018 - script improvement
...
Resource.RcvBuffer(1).rowsPerFrame = 8192;
...
Resource.DisplayWindow(1).Title = 'P4-2vFlash_64';
...
TX.Steer = [0,0];
TX.Apod = ones(1,Resource.Parameters.numTransmit);  % set TX.Apod for 64 elements
TX.aperture = 1;
