...
%   for its use
%
% File name: SetUpL11_4v_128RyLns_64.m - Example of linear array imaging with
...
% note nominal center frequency from computeTrans is 7.24 MHz
...
Resource.DisplayWindow(1).Title = 'L11-4v_128RyLns_64';
...
save('MatFiles/L11-4v_128RyLns_64');
