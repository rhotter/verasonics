...
%   for its use
%
% File name: SetUpL11_4vFlashAngles_64.m - Example of plane wave imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashAngles_64';
...
for j = 1:3:3*na
    TX(j).Apod(1:64) = 1;
    TX(j).aperture = computeMuxAperture(TX(j).Apod, Trans); % use computeMuxAperture function to get aperture number
...
save('MatFiles/L11-4vFlashAngles_64');
return
