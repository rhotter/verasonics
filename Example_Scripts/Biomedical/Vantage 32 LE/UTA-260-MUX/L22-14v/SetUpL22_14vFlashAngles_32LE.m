...
%   for its use
%
% File name: SetUpL22_14vFlashAngles_32LE.m - Example of plane wave imaging with multiple steered angle transmits
%
% Description:
...
Resource.DisplayWindow(1).Title = 'L22-14vFlashAngles_32LE';
...
save('MatFiles/L22-14vFlashAngles_32LE');
return
