...
%   for its use
%
% File name: SetUpL22_14vLF_FLashDoppler_32LE.m - Example of plane wave Doppler imaging, using FlashAngles for B-mode image
%
% Description:
...
%     L22-14vLF (18 MHz center frequency, ~67% bandwidth).
%
%   For Imaging:
...
Resource.DisplayWindow(1).Title = 'L22-14vLF Flash Doppler, 4X sampling at 62.5 MHz';
...
save('MatFiles/L22-14vLF_FlashDoppler_32LE');
return
