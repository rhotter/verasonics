...
%   for its use
%
% File name: SetUpL11_4v_128RyLns_32LE.m - Example of linear array imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4v_128RyLns_32LE';
...
save('MatFiles/L11-4v_128RyLns_32LE');
