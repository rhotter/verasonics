...
%   for its use
%
% File name: SetUpL11_4vFlashAngles_32LE.m - Example of plane wave imaging with
...
Resource.DisplayWindow(1).Title = 'L11-4vFlashAngles_32LE';
...
save('MatFiles/L11-4vFlashAngles_32LE');
return
