...
%   for its use
%
% File name: SetUpL11_5vFlashDoppler_32LE.m -  Example of 4-1 synthetic aperture doppler
%                                     imaging woth flash transmits
% Description:
%   Sequence programming file for L11-5v Linear array, using 4-1
...
Resource.DisplayWindow(1).Title = 'L11-5vFlashDoppler_32LE';
...
save('MatFiles/L11-5vFlashDoppler_32LE');
return
