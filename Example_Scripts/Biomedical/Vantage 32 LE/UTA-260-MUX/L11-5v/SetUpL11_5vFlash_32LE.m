...
%   for its use
%
% File name: SetUpL11_5vFlash_32LE.m - Example of 4-1 synthetic aperture plane
...
%   32 channels system. Dynamic Mux programming with the 260-MUX UTA allows transmitting
...
%   different acqNums in the Receive buffer. The reconstruction sums the IQ
%   data from four reconstructions and computes intensity values to produce
%   the full frame. Processing is asynchronous with respect to acquisition.
%
% Last update:
% 03/15/2019 - modified for use with 4.0
...
Resource.DisplayWindow(1).Title = 'L11-5vFlash_32LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames  % 4 acquisitions per frame
    ...
    % -- 3rd synthetic aperture acquisition.
    ...
    % -- 4nd synthetic aperture acquisition.
...
save('MatFiles/L11-5vFlash_32LE');
return
