...
%   for its use
%
% File name: SetUpP4_2v_128RyLns_32LE.m - Example of phased array imaging with
%                                    focus transmits
% Description:
%   Sequence programming file for P4-2v phased array in virtual apex format,
%   using 128 ray lines(focus transmits) and receive acquisitions. 64
%   transmit and 32 receive channels are active for each acquisition. The
...
Resource.DisplayWindow(1).Title = 'P4-2v_128RyLns_32LE';
...
save('MatFiles/P4-2v_128RyLns_32LE');
return
