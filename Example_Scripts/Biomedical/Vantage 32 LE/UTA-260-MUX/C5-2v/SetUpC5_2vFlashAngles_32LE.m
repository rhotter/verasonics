...
%   for its use
%
% File name: SetUpC5_2vFlashAngles_32LE.m - Example of curved array flash imaging
...
%
%
% 09/04/2018 Modified for 32LE system
...
Resource.RcvBuffer(1).rowsPerFrame = 4*na*4096;
...
Resource.DisplayWindow(1).Title = 'C5-2vFlashAngles_32LE';
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    for j = 1:4:4*na
        ...
        Receive(j+k+1).Apod = [zeros(1,16),ones(1,32),zeros(1,16)];
        ...
        Receive(j+k+2).Apod = [zeros(1,16),ones(1,32),zeros(1,16)];
...
save('MatFiles/C5-2vFlashAngles_32LE');
return
