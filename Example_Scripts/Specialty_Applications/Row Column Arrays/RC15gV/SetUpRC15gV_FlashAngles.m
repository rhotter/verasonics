...
Resource.DisplayWindow(1).Title = '3D RC15gV FlashAngles - XZ plane';
...
Resource.DisplayWindow(2).Title = '3D RC15gV FlashAngles - YZ plane';
...
Resource.DisplayWindow(3).Title = '3D RC15gV FlashAngles - XY plane';
...
save('MatFiles/RC15gV_FlashAngles');
return
