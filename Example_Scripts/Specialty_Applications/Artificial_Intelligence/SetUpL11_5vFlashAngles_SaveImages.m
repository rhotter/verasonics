% File name: SetUpL11_5vFlashAngles_SaveImages.m
% Example of plane wave imaging with steering angle transmits and
% exporting image data for classification training
%
% Description:
%   This example script uses the process-storage class to export image data
%   for classification. The data will be stored in UserData/AI and uses the
%   verasonics binary format. Please see the documentation about the
%   storage class for more details in
%   Example_Scripts/Vantage_Features/Data_Import_Export
%
% Usage:
...
%   This will start the exporting process, you should find .vrs files in
%   the UserData/AI folder.
%
%   Transmit Sequence:
...
[fp, ~, ~,]   = fileparts(str);
storageFolder = fullfile( fullfile(fp, 'UserData'), 'AI' );
...
Process(2).Parameters = { ...
    ...
    'maxfiles', 650, ... % Can be used to specify the maximum number of files
    ...
    'sampleID', 'A Sample ID', ... % will save 'Some NOtes' as a comment in the file header of each stored file
