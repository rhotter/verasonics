...
%   for its use.
%
% File name: SetUp_NDT_FMC_64_SH.m - Example of imaging using full matrix capature
...
UI(1).Control =  VsSliderControl('LocationCode','UserB7',...
    'Style','VsSlider','Label','Sens. Cutoff',...
