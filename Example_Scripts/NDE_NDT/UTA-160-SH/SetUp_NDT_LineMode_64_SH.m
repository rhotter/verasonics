...
%   for its use.
%
% File name: SetUp_NDT_LineMode_64_SH.m - Example of imaging using conventioanl line
% by line scan
%
% Description:
...
UI(1).Callback = @SensCutoffCallback;
...
save('MatFiles/NDT_LineMode_64_SH');
...
% filename = 'NDT_LineMode_64_SH'; VSX;
