...
%   for its use.
%
% File name: SetUp_NDT_FMC_UTA128LEMO_2El.m - Example of full matrix
% capature using the 128 LEMO UTA with 2 LEMO connectors activated
%
%
% Description:
%   Sequence programming file for full matrix capture using the 128 LEMO UTA
...
Trans.numelements = 2;
        ...
        Trans.ConnectorES = [16 116]'; % LEMO 16 and 116 are activated. LEMO 16 is seen as element 1. LEMO 116 is seen as element 2.
...
UI(1).Control = VsSliderControl('LocationCode','UserB2',...
    'Label','Trans El No.','SliderMinMaxVal',[1,Trans.numelements,1],...
...
save('MatFiles/NDT_FMC_UTA128LEMO_2El');
...
% filename = 'NDT_FMC_UTA128LEMO_2El'; VSX;
