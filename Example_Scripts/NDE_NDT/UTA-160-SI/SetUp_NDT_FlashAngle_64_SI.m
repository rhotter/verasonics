...
%   for its use.
%
% File name: SetUp_NDT_FlashAngle_64_SI - Example of imaging using tilted plane wave
%                              compounding on a 64 element phase array
%
% Description:
%   Sequence programming file for Olympus 5MHz 64 el Phase array, using plane wave compounding.
...
save('MatFiles/NDT_FlashAngle_64_SI');
...
% filename = 'NDT_FlashAngle_64_SI'; VSX;
