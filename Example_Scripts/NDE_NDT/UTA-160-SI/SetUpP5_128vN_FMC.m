...
%   for its use.
%
% File name: SetUpP5_128vN_FMC.m - Example of imaging using full matrix capture
%                         and total focusing reconstruction
%
% Description:
%   Sequence programming file for P5-128vN array, using total
%   focusing reconstruction. For each acquisition, one channel is active
%   for transmit and 128 channels are active for receive.
%
% Last update:
% 11/02/2020
...
SeqControl(4).argument = 200000;  % 200 ms
