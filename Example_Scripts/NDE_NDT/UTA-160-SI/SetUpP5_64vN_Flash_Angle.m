...
%   for its use.
%
% File name: SetUpP5_64vN_FlashAngle.m - Example of imaging using tilted plane wave
%                                         compounding.
%
% Description:
%   Sequence programming file for P5-64vN array, using total focusing reconstruction
...
save('MatFiles/P5_64vN_Flash_Angle');
...
% filename = 'P5_64vN_Flash_Angle'; VSX;
