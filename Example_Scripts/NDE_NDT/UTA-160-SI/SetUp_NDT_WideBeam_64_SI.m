...
%   for its use.
%
% File name: SetUp_NDT_WideBeam_64_SI.m - Example of imaging using overlapping
% widebeams
%
% Description:
%   Sequence programming file for Olympus 5MHz 64 el Phase array, using overlapping widebeams.
...
save('MatFiles/NDT_WideBeam_64_SI');
...
% filename = 'NDT_WideBeam_64_SI'; VSX;
