...
%   for its use.
%
% File name: SetUp_NDT_FMC_64_SI.m - Example of imaging using full matrix capature
%                         and total focusing reconstruction
%
% Description:
%   Sequence programming file for Olympus 5MHz 64 el Phase array, using total
