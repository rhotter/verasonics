...
%   for its use.
%
% File name: SetUp_NDT_LineMode.m - Example of imaging using conventioanl line
% by line scan
%
% Description:
%   Sequence programming file for Imasonic 5MHz Phase array, using line by line focused wave scan.
...
UI(3).Control = VsSliderControl('LocationCode','UserB4',...
    'Style','VsSlider','Label',['TX Focus (',AxesUnit,')'],...
