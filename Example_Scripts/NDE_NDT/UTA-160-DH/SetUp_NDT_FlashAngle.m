...
%   for its use.
%
% File name: SetUp_NDT_FlashAngle - Example of imaging using tilted plane wave
...
UI(1).Control =  VsSliderControl('LocationCode','UserB7',...
    'Label','Sens. Cutoff','SliderMinMaxVal',[0,1.0,Recon(1).senscutoff],...
