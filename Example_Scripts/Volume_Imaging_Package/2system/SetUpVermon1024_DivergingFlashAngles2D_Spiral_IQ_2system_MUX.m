...
%   for its use
%
% File name: SetUpVermon1024_DivergingFlashAngles2D_Spiral_IQ_2system_MUX.m
%
...
filename = 'Vermon1024_DivergingFlashAngles2D_Spiral_IQ_2system_MUX';
...
SeqControl(TTNAFRAME).argument = 0.1E6;  % 0.1 second
% Return to Matlab
RETMAT = 4;
