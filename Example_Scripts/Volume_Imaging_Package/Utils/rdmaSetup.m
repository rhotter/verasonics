...
%
warning('rdmaSetup:deprecated', 'rdmaSetup.m has been deprecated and should be replaced with vsv.multi.setup_4');
usingMultiSys = 1;
Resource.VDAS.dmaTimeout = 60*1000; % (ms) time software sequencer will wait for 'transferToHost'

%--- Standard System
%--- RDMAsystem 1---%
RDMAsystem(1).primaryDevName ='mlx5_0';
RDMAsystem(1).primaryIP = '10.10.1.1';
RDMAsystem(1).tcpPort = 5001;
RDMAsystem(1).secondaryDevName ='mlx5_0';
RDMAsystem(1).secondaryIP = '10.10.1.2';
%--- RDMAsystem 2---%
RDMAsystem(2).primaryDevName ='mlx5_1';
RDMAsystem(2).primaryIP = '10.10.2.1';
RDMAsystem(2).tcpPort = 5002;
RDMAsystem(2).secondaryDevName ='mlx5_0';
RDMAsystem(2).secondaryIP = '10.10.2.2';
%--- RDMAsystem 3---%
RDMAsystem(3).primaryDevName ='mlx5_2';
RDMAsystem(3).primaryIP = '10.10.3.1';
RDMAsystem(3).tcpPort = 5003;
RDMAsystem(3).secondaryDevName ='mlx5_0';
RDMAsystem(3).secondaryIP = '10.10.3.2';
%------------------------------%
%--- Specialty System
% %--- RDMAsystem 1---%
% RDMAsystem(1).primaryDevName ='mlx5_0';
% RDMAsystem(1).primaryIP = '10.10.0.1';
% RDMAsystem(1).port = 5001;
% RDMAsystem(1).secondaryDevName ='mlx5_0';
% RDMAsystem(1).secondaryIP = '10.10.0.2';
% %--- RDMAsystem 2---%
% RDMAsystem(2).primaryDevName ='mlx5_1';
% RDMAsystem(2).primaryIP = '10.10.1.1';
% RDMAsystem(2).port = 5002;
% RDMAsystem(2).secondaryDevName ='mlx5_0';
% RDMAsystem(2).secondaryIP = '10.10.1.2';
% %--- RDMAsystem 3---%
% RDMAsystem(3).primaryDevName ='mlx5_2';
% RDMAsystem(3).primaryIP = '10.10.2.1';
% RDMAsystem(3).port = 5003;
% RDMAsystem(3).secondaryDevName ='mlx5_0';
% RDMAsystem(3).secondaryIP = '10.10.2.2';
% %--- RDMAsystem 4---%
% RDMAsystem(4).primaryDevName ='mlx5_3';
% RDMAsystem(4).primaryIP = '10.10.3.1';
% RDMAsystem(4).port = 5003;
...
RDMAconfig.numSecondaryNodes = 3;
