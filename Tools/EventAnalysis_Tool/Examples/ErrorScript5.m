% ErrorScript5 has bugs about TX and Receive
% each receive should be unique, otherwise the buffer will be overwritten
% by next receive event and some buffers may never be filled.
...
Resource.DisplayWindow(1).Title = 'Error5';
